...
# Files
disk = 1
inFile   = "GCCbandOTF.fits"          # input OTF data
dirtFile = "!GCCDirty.fits"           # output dirty image file
...
OTF.ImageInput["nx"] = 600                 # number of cells in X
OTF.ImageInput["ny"] = 600                 # number of cells in X
