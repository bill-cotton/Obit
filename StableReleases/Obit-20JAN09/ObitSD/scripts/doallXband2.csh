...
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal1.fits -calType Filter -SOLINT 20. -MINEL 5.0 -GAINUSE -1 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal1.fits -calType Filter -SOLINT 20.0 -MINEL 5.0 -GAINUSE -1 -FLAGVER 1
...
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal2.fits -calType Filter -SOLINT 20.0 -MINEL 5.0 -GAINUSE 1 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal2.fits -calType Filter -SOLINT 20.0 -MINEL 5.0 -GAINUSE 1 -FLAGVER 1
...
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal3.fits --calType Filter SOLINT 15.0 -MINEL 5.0 -GAINUSE 2 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal3.fits -calType Filter -SOLINT 15.0 -MINEL 5.0 -GAINUSE 2 -FLAGVER 1
...
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal4.fits -calType Filter -SOLINT 15.0 -MINEL 5.0 -GAINUSE 3 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXcal4.fits -calType Filter -SOLINT 15.0 -MINEL 5.0 -GAINUSE 3 -FLAGVER 1
...
echo test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXcal8.fits -calType Filter -SOLINT 5.0 -MINEL 5.0 -GAINUSE 4 -FLAGVER 1
