...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal1.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 1000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal1.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 1000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
# Residual calibration with result of last time
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 90. -MINEL 5.0 -GAINUSE -1 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 90.0 -MINEL 5.0 -GAINUSE -1 -FLAGVER 1
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal2.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 1000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal2.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 1000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
# Residual calibration pass 2
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 90.0 -MINEL 5.0 -GAINUSE 1 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 90.0 -MINEL 5.0 -GAINUSE 1 -FLAGVER 1
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal2.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 2000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal3.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 2000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
# Residual calibration pass 3
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits --calType Filter SOLINT 45.0 -MINEL 5.0 -GAINUSE 2 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 45.0 -MINEL 5.0 -GAINUSE 2 -FLAGVER 1
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal4.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 2000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal4.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 2000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
# Residual calibration pass 4 - Filter calibration
echo test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 45.0 -MINEL 5.0 -GAINUSE 3 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX.in -image GCXClean.fits -calType Filter -SOLINT 45.0 -MINEL 5.0 -GAINUSE 3 -FLAGVER 1
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal5.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal5.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
echo test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 10.0 -MINEL 5.0 -GAINUSE -1 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 10.0 -MINEL 5.0 -GAINUSE -1 -FLAGVER 1
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal6.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal6.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
echo test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 10.0 -MINEL 5.0 -GAINUSE 1 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 10.0 -MINEL 5.0 -GAINUSE 1 -FLAGVER 1
# Convert Soln 2 + Cal 1 to Cal table 2
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal7.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal7.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
echo test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 10.0 -MINEL 5.0 -GAINUSE 2 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 10.0 -MINEL 5.0 -GAINUSE 2 -FLAGVER 1
# Convert Soln 3 + Cal 2 to Cal table 3
...
# another calibration pass - use boxcar
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal8.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal8.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
echo test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 5.0 -MINEL 5.0 -GAINUSE 3 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 5.0 -MINEL 5.0 -GAINUSE 3 -FLAGVER 1
# Convert Soln 4 + Cal 3 to Cal table 4
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal9.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal9.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 3000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
echo test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 5.0 -MINEL 5.0 -GAINUSE 4 -FLAGVER 1
test/ResidCalOTF -input input/ResidCalOTFX2.in -image GCXClean.fits -calType Filter -SOLINT 5.0 -MINEL 5.0 -GAINUSE 4 -FLAGVER 1
...
# Clean
echo test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal10.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 5000 -GAIN 0.03  -FLUX 1.0 -BEAMSIZE 87.4
test/CleanOTF -input input/CleanOTF.in -dirtyfile GCXcal10.fits -beamfile DirtyBeam.fits \
-cleanfile \!GCXClean.fits -NITER 5000 -GAIN 0.03 -FLUX 1.0 -BEAMSIZE 87.4
