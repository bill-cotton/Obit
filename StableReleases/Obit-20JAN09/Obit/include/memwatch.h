...
char* mwStrndup( const char *, int, const char*, int );
char* mwStrconcat( const char*, int, ... );
#define g_malloc(n)     mwMalloc(n,__FILE__,__LINE__)
#define g_malloc0(n)    mwCalloc(1, n,__FILE__,__LINE__)
#define g_strdup(p)     mwStrdup(p,__FILE__,__LINE__)
#define g_strndup(p,n)  mwStrndup(p,n,__FILE__,__LINE__)
#define g_strconcat(p1...)  mwStrconcat(__FILE__,__LINE__,p1)
...
#define g_free(p)       mwFree(p,__FILE__,__LINE__)
  ...
  /* Obit memory routines */
void* mwFreeNULL( void* ,const char*, int );
#define ObitMemAlloc(s)         mwMalloc(s,__FILE__,__LINE__)
#define ObitMemAlloc0(s)        mwCalloc(1, s,__FILE__,__LINE__)
#define ObitMemAllocName(s,n)   mwMalloc(s,__FILE__,__LINE__)
#define ObitMemAlloc0Name(s,n)  mwCalloc(1, s,__FILE__,__LINE__)
#define ObitMemRealloc(p,n)     mwRealloc(p,n,__FILE__,__LINE__)
#define ObitMemValid(p)         !mwTestBuffer(__FILE__,__LINE__,p)
#define ObitMemFree(p)          mwFreeNULL(p,__FILE__,__LINE__)
