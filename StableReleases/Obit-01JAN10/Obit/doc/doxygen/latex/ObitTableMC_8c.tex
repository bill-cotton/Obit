\section{Obit\-Table\-MC.c File Reference}
\label{ObitTableMC_8c}\index{ObitTableMC.c@{ObitTableMC.c}}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!newObitTableMC@{newObitTableMC}}
\index{newObitTableMC@{newObitTableMC}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ new\-Obit\-Table\-MC (gchar $\ast$ {\em name})}\label{ObitTableMC_8c_a16}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!newObitTableMCRow@{newObitTableMCRow}}
\index{newObitTableMCRow@{newObitTableMCRow}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MCRow}$\ast$ new\-Obit\-Table\-MCRow ({\bf Obit\-Table\-MC} $\ast$ {\em table})}\label{ObitTableMC_8c_a14}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!newObitTableMCValue@{newObitTableMCValue}}
\index{newObitTableMCValue@{newObitTableMCValue}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ new\-Obit\-Table\-MCValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf oint} {\em num\-Band}, {\bf oint} {\em num\-Pol}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMC_8c_a18}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCClassInit@{ObitTableMCClassInit}}
\index{ObitTableMCClassInit@{ObitTableMCClassInit}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MCClass\-Init (void)}\label{ObitTableMC_8c_a27}


Public: Class initializer. 

\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCClear@{ObitTableMCClear}}
\index{ObitTableMCClear@{ObitTableMCClear}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCClose@{ObitTableMCClose}}
\index{ObitTableMCClose@{ObitTableMCClose}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCConvert@{ObitTableMCConvert}}
\index{ObitTableMCConvert@{ObitTableMCConvert}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ Obit\-Table\-MCConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableMC_8c_a19}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCCopy@{ObitTableMCCopy}}
\index{ObitTableMCCopy@{ObitTableMCCopy}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ Obit\-Table\-MCCopy ({\bf Obit\-Table\-MC} $\ast$ {\em in}, {\bf Obit\-Table\-MC} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMC_8c_a20}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCGetClass@{ObitTableMCGetClass}}
\index{ObitTableMCGetClass@{ObitTableMCGetClass}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCInit@{ObitTableMCInit}}
\index{ObitTableMCInit@{ObitTableMCInit}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MCInit (gpointer {\em inn})}\label{ObitTableMC_8c_a8}
...
\end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCOpen@{ObitTableMCOpen}}
\index{ObitTableMCOpen@{ObitTableMCOpen}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\end{itemize}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCReadRow@{ObitTableMCReadRow}}
\index{ObitTableMCReadRow@{ObitTableMCReadRow}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCRowClassInit@{ObitTableMCRowClassInit}}
\index{ObitTableMCRowClassInit@{ObitTableMCRowClassInit}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MCRow\-Class\-Init (void)}\label{ObitTableMC_8c_a26}


Public: Row Class initializer. 

\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCRowClear@{ObitTableMCRowClear}}
\index{ObitTableMCRowClear@{ObitTableMCRowClear}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCRowGetClass@{ObitTableMCRowGetClass}}
\index{ObitTableMCRowGetClass@{ObitTableMCRowGetClass}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-MCRow\-Get\-Class (void)}\label{ObitTableMC_8c_a15}
...
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCRowInit@{ObitTableMCRowInit}}
\index{ObitTableMCRowInit@{ObitTableMCRowInit}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\item[{\em inn}]Pointer to the object to initialize. \end{description}
\end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCSetRow@{ObitTableMCSetRow}}
\index{ObitTableMCSetRow@{ObitTableMCSetRow}!ObitTableMC.c@{Obit\-Table\-MC.c}}
...
\end{Desc}
\index{ObitTableMC.c@{Obit\-Table\-MC.c}!ObitTableMCWriteRow@{ObitTableMCWriteRow}}
\index{ObitTableMCWriteRow@{ObitTableMCWriteRow}!ObitTableMC.c@{Obit\-Table\-MC.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-Table\-MCWrite\-Row ({\bf Obit\-Table\-MC} $\ast$ {\em in}, {\bf olong} {\em i\-MCRow}, {\bf Obit\-Table\-MCRow} $\ast$ {\em row}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMC_8c_a24}
