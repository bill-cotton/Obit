\section{Obit\-IOHistory\-AIPS.h File Reference}
\label{ObitIOHistoryAIPS_8h}\index{ObitIOHistoryAIPS.h@{ObitIOHistoryAIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSIsA@{ObitIOHistoryAIPSIsA}}
\index{ObitIOHistoryAIPSIsA@{ObitIOHistoryAIPSIsA}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSRef@{ObitIOHistoryAIPSRef}}
\index{ObitIOHistoryAIPSRef@{ObitIOHistoryAIPSRef}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-IOHistory\-AIPSRef(in)\ Obit\-Ref (in)}\label{ObitIOHistoryAIPS_8h_a1}


Macro to reference (update reference count) an {\bf Obit\-IOHistory\-AIPS}{\rm (p.\,\pageref{structObitIOHistoryAIPS})}. 

returns a Obit\-IOHistory\-AIPS$\ast$. in = object to reference \index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSUnref@{ObitIOHistoryAIPSUnref}}
\index{ObitIOHistoryAIPSUnref@{ObitIOHistoryAIPSUnref}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSReadRecFP@{ObitIOHistoryAIPSReadRecFP}}
\index{ObitIOHistoryAIPSReadRecFP@{ObitIOHistoryAIPSReadRecFP}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSWriteRecFP@{ObitIOHistoryAIPSWriteRecFP}}
\index{ObitIOHistoryAIPSWriteRecFP@{ObitIOHistoryAIPSWriteRecFP}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!newObitIOHistoryAIPS@{newObitIOHistoryAIPS}}
\index{newObitIOHistoryAIPS@{newObitIOHistoryAIPS}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-IOHistory\-AIPS}$\ast$ new\-Obit\-IOHistory\-AIPS (gchar $\ast$ {\em name}, {\bf Obit\-Info\-List} $\ast$ {\em info}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a6}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSClassInit@{ObitIOHistoryAIPSClassInit}}
\index{ObitIOHistoryAIPSClassInit@{ObitIOHistoryAIPSClassInit}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-IOHistory\-AIPSClass\-Init (void)}\label{ObitIOHistoryAIPS_8h_a5}


Public: Class initializer. 

\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSClose@{ObitIOHistoryAIPSClose}}
\index{ObitIOHistoryAIPSClose@{ObitIOHistoryAIPSClose}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-IOHistory\-AIPSClose ({\bf Obit\-IOHistory\-AIPS} $\ast$ {\em in}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a12}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSCopy@{ObitIOHistoryAIPSCopy}}
\index{ObitIOHistoryAIPSCopy@{ObitIOHistoryAIPSCopy}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-IOHistory\-AIPS}$\ast$ Obit\-IOHistory\-AIPSCopy ({\bf Obit\-IOHistory\-AIPS} $\ast$ {\em in}, {\bf Obit\-IOHistory\-AIPS} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a10}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSFlush@{ObitIOHistoryAIPSFlush}}
\index{ObitIOHistoryAIPSFlush@{ObitIOHistoryAIPSFlush}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-IOHistory\-AIPSFlush ({\bf Obit\-IOHistory\-AIPS} $\ast$ {\em in}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a16}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSGetClass@{ObitIOHistoryAIPSGetClass}}
\index{ObitIOHistoryAIPSGetClass@{ObitIOHistoryAIPSGetClass}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSNumRec@{ObitIOHistoryAIPSNumRec}}
\index{ObitIOHistoryAIPSNumRec@{ObitIOHistoryAIPSNumRec}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf olong} Obit\-IOHistory\-AIPSNum\-Rec ({\bf Obit\-IOHistory} $\ast$ {\em in})}\label{ObitIOHistoryAIPS_8h_a19}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSOpen@{ObitIOHistoryAIPSOpen}}
\index{ObitIOHistoryAIPSOpen@{ObitIOHistoryAIPSOpen}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSReadDescriptor@{ObitIOHistoryAIPSReadDescriptor}}
\index{ObitIOHistoryAIPSReadDescriptor@{ObitIOHistoryAIPSReadDescriptor}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-IOHistory\-AIPSRead\-Descriptor ({\bf Obit\-IOHistory\-AIPS} $\ast$ {\em in}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a17}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSReadRrec@{ObitIOHistoryAIPSReadRrec}}
\index{ObitIOHistoryAIPSReadRrec@{ObitIOHistoryAIPSReadRrec}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSSame@{ObitIOHistoryAIPSSame}}
\index{ObitIOHistoryAIPSSame@{ObitIOHistoryAIPSSame}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSSet@{ObitIOHistoryAIPSSet}}
\index{ObitIOHistoryAIPSSet@{ObitIOHistoryAIPSSet}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSWriteDescriptor@{ObitIOHistoryAIPSWriteDescriptor}}
\index{ObitIOHistoryAIPSWriteDescriptor@{ObitIOHistoryAIPSWriteDescriptor}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-IOHistory\-AIPSWrite\-Descriptor ({\bf Obit\-IOHistory\-AIPS} $\ast$ {\em in}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a18}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSWriteRec@{ObitIOHistoryAIPSWriteRec}}
\index{ObitIOHistoryAIPSWriteRec@{ObitIOHistoryAIPSWriteRec}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}!ObitIOHistoryAIPSZap@{ObitIOHistoryAIPSZap}}
\index{ObitIOHistoryAIPSZap@{ObitIOHistoryAIPSZap}!ObitIOHistoryAIPS.h@{Obit\-IOHistory\-AIPS.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-IOHistory\-AIPSZap ({\bf Obit\-IOHistory\-AIPS} $\ast$ {\em in}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitIOHistoryAIPS_8h_a9}
