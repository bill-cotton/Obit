\section{Obit\-Table\-OF.h File Reference}
\label{ObitTableOF_8h}\index{ObitTableOF.h@{ObitTableOF.h}}
...
\subsection{Specifying desired data transfer parameters}\label{ObitTableOF_8h_ObitTableOFSpecification}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!MAXKEYCHARTABLEOF@{MAXKEYCHARTABLEOF}}
\index{MAXKEYCHARTABLEOF@{MAXKEYCHARTABLEOF}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAXKEYCHARTABLEOF\ 24}\label{ObitTableOF_8h_a0}


Number of characters for Table keyword. 

\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFIsA@{ObitTableOFIsA}}
\index{ObitTableOFIsA@{ObitTableOFIsA}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFRef@{ObitTableOFRef}}
\index{ObitTableOFRef@{ObitTableOFRef}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
returns an Obit\-Table\-OF$\ast$. in = object to reference \index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFRowIsA@{ObitTableOFRowIsA}}
\index{ObitTableOFRowIsA@{ObitTableOFRowIsA}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFRowRef@{ObitTableOFRowRef}}
\index{ObitTableOFRowRef@{ObitTableOFRowRef}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
returns an Obit\-Table\-OFRow$\ast$. in = object to reference \index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFRowUnref@{ObitTableOFRowUnref}}
\index{ObitTableOFRowUnref@{ObitTableOFRowUnref}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-Table\-OFRow\-Unref(in)\ Obit\-Unref (in)}\label{ObitTableOF_8h_a4}


Macro to unreference (and possibly destroy) an {\bf Obit\-Table\-OFRow}{\rm (p.\,\pageref{structObitTableOFRow})} returns an Obit\-Table\-OFRow$\ast$. 

in = object to unreference \index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFUnref@{ObitTableOFUnref}}
\index{ObitTableOFUnref@{ObitTableOFUnref}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!newObitTableOF@{newObitTableOF}}
\index{newObitTableOF@{newObitTableOF}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OF}$\ast$ new\-Obit\-Table\-OF (gchar $\ast$ {\em name})}\label{ObitTableOF_8h_a11}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!newObitTableOFRow@{newObitTableOFRow}}
\index{newObitTableOFRow@{newObitTableOFRow}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OFRow}$\ast$ new\-Obit\-Table\-OFRow ({\bf Obit\-Table\-OF} $\ast$ {\em table})}\label{ObitTableOF_8h_a8}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!newObitTableOFValue@{newObitTableOFValue}}
\index{newObitTableOFValue@{newObitTableOFValue}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OF}$\ast$ new\-Obit\-Table\-OFValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableOF_8h_a12}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFClassInit@{ObitTableOFClassInit}}
\index{ObitTableOFClassInit@{ObitTableOFClassInit}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-OFClass\-Init (void)}\label{ObitTableOF_8h_a10}


Public: Class initializer. 

\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFClone@{ObitTableOFClone}}
\index{ObitTableOFClone@{ObitTableOFClone}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OF}$\ast$ Obit\-Table\-OFClone ({\bf Obit\-Table\-OF} $\ast$ {\em in}, {\bf Obit\-Table\-OF} $\ast$ {\em out})}\label{ObitTableOF_8h_a15}


Public: Copy (shallow) constructor. 

\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFClose@{ObitTableOFClose}}
\index{ObitTableOFClose@{ObitTableOFClose}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFConvert@{ObitTableOFConvert}}
\index{ObitTableOFConvert@{ObitTableOFConvert}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OF}$\ast$ Obit\-Table\-OFConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableOF_8h_a16}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFCopy@{ObitTableOFCopy}}
\index{ObitTableOFCopy@{ObitTableOFCopy}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OF}$\ast$ Obit\-Table\-OFCopy ({\bf Obit\-Table\-OF} $\ast$ {\em in}, {\bf Obit\-Table\-OF} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableOF_8h_a14}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFGetClass@{ObitTableOFGetClass}}
\index{ObitTableOFGetClass@{ObitTableOFGetClass}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-OFGet\-Class (void)}\label{ObitTableOF_8h_a13}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFOpen@{ObitTableOFOpen}}
\index{ObitTableOFOpen@{ObitTableOFOpen}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
\end{itemize}
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFReadRow@{ObitTableOFReadRow}}
\index{ObitTableOFReadRow@{ObitTableOFReadRow}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFRowClassInit@{ObitTableOFRowClassInit}}
\index{ObitTableOFRowClassInit@{ObitTableOFRowClassInit}!ObitTableOF.h@{Obit\-Table\-OF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-OFRow\-Class\-Init (void)}\label{ObitTableOF_8h_a7}


Public: Row Class initializer. 

\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFRowGetClass@{ObitTableOFRowGetClass}}
\index{ObitTableOFRowGetClass@{ObitTableOFRowGetClass}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFSetRow@{ObitTableOFSetRow}}
\index{ObitTableOFSetRow@{ObitTableOFSetRow}!ObitTableOF.h@{Obit\-Table\-OF.h}}
...
\end{Desc}
\index{ObitTableOF.h@{Obit\-Table\-OF.h}!ObitTableOFWriteRow@{ObitTableOFWriteRow}}
\index{ObitTableOFWriteRow@{ObitTableOFWriteRow}!ObitTableOF.h@{Obit\-Table\-OF.h}}
