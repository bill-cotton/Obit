\section{Obit\-Table\-OB.h File Reference}
\label{ObitTableOB_8h}\index{ObitTableOB.h@{ObitTableOB.h}}
...
\subsection{Specifying desired data transfer parameters}\label{ObitTableOB_8h_ObitTableOBSpecification}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!MAXKEYCHARTABLEOB@{MAXKEYCHARTABLEOB}}
\index{MAXKEYCHARTABLEOB@{MAXKEYCHARTABLEOB}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAXKEYCHARTABLEOB\ 24}\label{ObitTableOB_8h_a0}


Number of characters for Table keyword. 

\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBIsA@{ObitTableOBIsA}}
\index{ObitTableOBIsA@{ObitTableOBIsA}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBRef@{ObitTableOBRef}}
\index{ObitTableOBRef@{ObitTableOBRef}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
returns an Obit\-Table\-OB$\ast$. in = object to reference \index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBRowIsA@{ObitTableOBRowIsA}}
\index{ObitTableOBRowIsA@{ObitTableOBRowIsA}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBRowRef@{ObitTableOBRowRef}}
\index{ObitTableOBRowRef@{ObitTableOBRowRef}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
returns an Obit\-Table\-OBRow$\ast$. in = object to reference \index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBRowUnref@{ObitTableOBRowUnref}}
\index{ObitTableOBRowUnref@{ObitTableOBRowUnref}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-Table\-OBRow\-Unref(in)\ Obit\-Unref (in)}\label{ObitTableOB_8h_a4}


Macro to unreference (and possibly destroy) an {\bf Obit\-Table\-OBRow}{\rm (p.\,\pageref{structObitTableOBRow})} returns an Obit\-Table\-OBRow$\ast$. 

in = object to unreference \index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBUnref@{ObitTableOBUnref}}
\index{ObitTableOBUnref@{ObitTableOBUnref}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!newObitTableOB@{newObitTableOB}}
\index{newObitTableOB@{newObitTableOB}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OB}$\ast$ new\-Obit\-Table\-OB (gchar $\ast$ {\em name})}\label{ObitTableOB_8h_a11}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!newObitTableOBRow@{newObitTableOBRow}}
\index{newObitTableOBRow@{newObitTableOBRow}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OBRow}$\ast$ new\-Obit\-Table\-OBRow ({\bf Obit\-Table\-OB} $\ast$ {\em table})}\label{ObitTableOB_8h_a8}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!newObitTableOBValue@{newObitTableOBValue}}
\index{newObitTableOBValue@{newObitTableOBValue}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OB}$\ast$ new\-Obit\-Table\-OBValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableOB_8h_a12}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBClassInit@{ObitTableOBClassInit}}
\index{ObitTableOBClassInit@{ObitTableOBClassInit}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-OBClass\-Init (void)}\label{ObitTableOB_8h_a10}


Public: Class initializer. 

\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBClone@{ObitTableOBClone}}
\index{ObitTableOBClone@{ObitTableOBClone}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OB}$\ast$ Obit\-Table\-OBClone ({\bf Obit\-Table\-OB} $\ast$ {\em in}, {\bf Obit\-Table\-OB} $\ast$ {\em out})}\label{ObitTableOB_8h_a15}


Public: Copy (shallow) constructor. 

\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBClose@{ObitTableOBClose}}
\index{ObitTableOBClose@{ObitTableOBClose}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBConvert@{ObitTableOBConvert}}
\index{ObitTableOBConvert@{ObitTableOBConvert}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OB}$\ast$ Obit\-Table\-OBConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableOB_8h_a16}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBCopy@{ObitTableOBCopy}}
\index{ObitTableOBCopy@{ObitTableOBCopy}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-OB}$\ast$ Obit\-Table\-OBCopy ({\bf Obit\-Table\-OB} $\ast$ {\em in}, {\bf Obit\-Table\-OB} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableOB_8h_a14}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBGetClass@{ObitTableOBGetClass}}
\index{ObitTableOBGetClass@{ObitTableOBGetClass}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-OBGet\-Class (void)}\label{ObitTableOB_8h_a13}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBOpen@{ObitTableOBOpen}}
\index{ObitTableOBOpen@{ObitTableOBOpen}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
\end{itemize}
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBReadRow@{ObitTableOBReadRow}}
\index{ObitTableOBReadRow@{ObitTableOBReadRow}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBRowClassInit@{ObitTableOBRowClassInit}}
\index{ObitTableOBRowClassInit@{ObitTableOBRowClassInit}!ObitTableOB.h@{Obit\-Table\-OB.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-OBRow\-Class\-Init (void)}\label{ObitTableOB_8h_a7}


Public: Row Class initializer. 

\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBRowGetClass@{ObitTableOBRowGetClass}}
\index{ObitTableOBRowGetClass@{ObitTableOBRowGetClass}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBSetRow@{ObitTableOBSetRow}}
\index{ObitTableOBSetRow@{ObitTableOBSetRow}!ObitTableOB.h@{Obit\-Table\-OB.h}}
...
\end{Desc}
\index{ObitTableOB.h@{Obit\-Table\-OB.h}!ObitTableOBWriteRow@{ObitTableOBWriteRow}}
\index{ObitTableOBWriteRow@{ObitTableOBWriteRow}!ObitTableOB.h@{Obit\-Table\-OB.h}}
