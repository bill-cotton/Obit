\section{Obit\-Table\-MF.h File Reference}
\label{ObitTableMF_8h}\index{ObitTableMF.h@{ObitTableMF.h}}
...
\subsection{Specifying desired data transfer parameters}\label{ObitTableMF_8h_ObitTableMFSpecification}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!MAXKEYCHARTABLEMF@{MAXKEYCHARTABLEMF}}
\index{MAXKEYCHARTABLEMF@{MAXKEYCHARTABLEMF}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAXKEYCHARTABLEMF\ 24}\label{ObitTableMF_8h_a0}


Number of characters for Table keyword. 

\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFIsA@{ObitTableMFIsA}}
\index{ObitTableMFIsA@{ObitTableMFIsA}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFRef@{ObitTableMFRef}}
\index{ObitTableMFRef@{ObitTableMFRef}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
returns an Obit\-Table\-MF$\ast$. in = object to reference \index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFRowIsA@{ObitTableMFRowIsA}}
\index{ObitTableMFRowIsA@{ObitTableMFRowIsA}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFRowRef@{ObitTableMFRowRef}}
\index{ObitTableMFRowRef@{ObitTableMFRowRef}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
returns an Obit\-Table\-MFRow$\ast$. in = object to reference \index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFRowUnref@{ObitTableMFRowUnref}}
\index{ObitTableMFRowUnref@{ObitTableMFRowUnref}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-Table\-MFRow\-Unref(in)\ Obit\-Unref (in)}\label{ObitTableMF_8h_a4}


Macro to unreference (and possibly destroy) an {\bf Obit\-Table\-MFRow}{\rm (p.\,\pageref{structObitTableMFRow})} returns an Obit\-Table\-MFRow$\ast$. 

in = object to unreference \index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFUnref@{ObitTableMFUnref}}
\index{ObitTableMFUnref@{ObitTableMFUnref}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!newObitTableMF@{newObitTableMF}}
\index{newObitTableMF@{newObitTableMF}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MF}$\ast$ new\-Obit\-Table\-MF (gchar $\ast$ {\em name})}\label{ObitTableMF_8h_a11}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!newObitTableMFRow@{newObitTableMFRow}}
\index{newObitTableMFRow@{newObitTableMFRow}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MFRow}$\ast$ new\-Obit\-Table\-MFRow ({\bf Obit\-Table\-MF} $\ast$ {\em table})}\label{ObitTableMF_8h_a8}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!newObitTableMFValue@{newObitTableMFValue}}
\index{newObitTableMFValue@{newObitTableMFValue}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MF}$\ast$ new\-Obit\-Table\-MFValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMF_8h_a12}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFClassInit@{ObitTableMFClassInit}}
\index{ObitTableMFClassInit@{ObitTableMFClassInit}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MFClass\-Init (void)}\label{ObitTableMF_8h_a10}


Public: Class initializer. 

\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFClone@{ObitTableMFClone}}
\index{ObitTableMFClone@{ObitTableMFClone}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MF}$\ast$ Obit\-Table\-MFClone ({\bf Obit\-Table\-MF} $\ast$ {\em in}, {\bf Obit\-Table\-MF} $\ast$ {\em out})}\label{ObitTableMF_8h_a15}


Public: Copy (shallow) constructor. 

\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFClose@{ObitTableMFClose}}
\index{ObitTableMFClose@{ObitTableMFClose}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFConvert@{ObitTableMFConvert}}
\index{ObitTableMFConvert@{ObitTableMFConvert}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MF}$\ast$ Obit\-Table\-MFConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableMF_8h_a16}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFCopy@{ObitTableMFCopy}}
\index{ObitTableMFCopy@{ObitTableMFCopy}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MF}$\ast$ Obit\-Table\-MFCopy ({\bf Obit\-Table\-MF} $\ast$ {\em in}, {\bf Obit\-Table\-MF} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMF_8h_a14}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFGetClass@{ObitTableMFGetClass}}
\index{ObitTableMFGetClass@{ObitTableMFGetClass}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-MFGet\-Class (void)}\label{ObitTableMF_8h_a13}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFOpen@{ObitTableMFOpen}}
\index{ObitTableMFOpen@{ObitTableMFOpen}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
\end{itemize}
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFReadRow@{ObitTableMFReadRow}}
\index{ObitTableMFReadRow@{ObitTableMFReadRow}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFRowClassInit@{ObitTableMFRowClassInit}}
\index{ObitTableMFRowClassInit@{ObitTableMFRowClassInit}!ObitTableMF.h@{Obit\-Table\-MF.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MFRow\-Class\-Init (void)}\label{ObitTableMF_8h_a7}


Public: Row Class initializer. 

\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFRowGetClass@{ObitTableMFRowGetClass}}
\index{ObitTableMFRowGetClass@{ObitTableMFRowGetClass}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFSetRow@{ObitTableMFSetRow}}
\index{ObitTableMFSetRow@{ObitTableMFSetRow}!ObitTableMF.h@{Obit\-Table\-MF.h}}
...
\end{Desc}
\index{ObitTableMF.h@{Obit\-Table\-MF.h}!ObitTableMFWriteRow@{ObitTableMFWriteRow}}
\index{ObitTableMFWriteRow@{ObitTableMFWriteRow}!ObitTableMF.h@{Obit\-Table\-MF.h}}
