\section{Obit\-AIPSFortran.c File Reference}
\label{ObitAIPSFortran_8c}\index{ObitAIPSFortran.c@{ObitAIPSFortran.c}}
...
\index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!Obit_traceback_end@{Obit\_\-traceback\_\-end}}
\index{Obit_traceback_end@{Obit\_\-traceback\_\-end}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
...
Writes traceback info, writes error log, deleted obit\-Err and returns (no return value). This whould be used when returning from a fortran callable routine. \begin{itemize}
...
\index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!obimuv_@{obimuv\_\-}}
\index{obimuv_@{obimuv\_\-}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
...
\end{Desc}
\index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!obintx_@{obintx\_\-}}
\index{obintx_@{obintx\_\-}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
...
\end{Desc}
\end{itemize}
\index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!obiuvi_@{obiuvi\_\-}}
\index{obiuvi_@{obiuvi\_\-}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void obiuvi\_\- ({\bf AIPSObj} {\em uvdata}, {\bf oint} $\ast$ {\em ifield}, {\bf oint} $\ast$ {\em nfield}, {\bf AIPSObj} $\ast$ {\em image}, {\bf AIPSObj} $\ast$ {\em beam}, {\bf oint} $\ast$ {\em dobeam}, {\bf oint} $\ast$ {\em docreate}, {\bf oint} $\ast$ {\em chan}, {\bf oint} $\ast$ {\em nchan}, {\bf oint} $\ast$ {\em imchan}, {\bf oint} $\ast$ {\em ierr})}\label{ObitAIPSFortran_8c_a9}
...
\item[{\em dobeam}]if True, make a beam else make an image \item[{\em docreate}]if True, create beams and images underlying AIPS files \item[{\em chan}]First channel in uv data to image \item[{\em nchan}]Number of channels to \char`\"{}average\char`\"{} into the image \item[{\em imchan}]First channel number in output image or beam \item[{\em ierr}]return code, 0=$>$OK \end{description}
\end{Desc}
\index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!obshtx_@{obshtx\_\-}}
\index{obshtx_@{obshtx\_\-}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void obshtx\_\- (void)}\label{ObitAIPSFortran_8c_a5}


Public: Shutdown {\bf Obit}{\rm (p.\,\pageref{structObit})} System. 

Shutdown {\bf Obit\-System}{\rm (p.\,\pageref{structObitSystem})} information This should be called ONCE after all {\bf Obit}{\rm (p.\,\pageref{structObit})} routines are called. Any remaining scratch objects/files are deleted. \index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!obufwt_@{obufwt\_\-}}
\index{obufwt_@{obufwt\_\-}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
...
\end{Desc}
\index{ObitAIPSFortran.c@{Obit\-AIPSFortran.c}!obuvcp_@{obuvcp\_\-}}
\index{obuvcp_@{obuvcp\_\-}!ObitAIPSFortran.c@{Obit\-AIPSFortran.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void obuvcp\_\- ({\bf AIPSObj} {\em uvin}, {\bf AIPSObj} {\em uvout}, {\bf oint} $\ast$ {\em ierr})}\label{ObitAIPSFortran_8c_a6}
