\section{Obit\-Table\-PC.h File Reference}
\label{ObitTablePC_8h}\index{ObitTablePC.h@{ObitTablePC.h}}
...
\subsection{Specifying desired data transfer parameters}\label{ObitTablePC_8h_ObitTablePCSpecification}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!MAXKEYCHARTABLEPC@{MAXKEYCHARTABLEPC}}
\index{MAXKEYCHARTABLEPC@{MAXKEYCHARTABLEPC}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAXKEYCHARTABLEPC\ 24}\label{ObitTablePC_8h_a0}


Number of characters for Table keyword. 

\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCIsA@{ObitTablePCIsA}}
\index{ObitTablePCIsA@{ObitTablePCIsA}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCRef@{ObitTablePCRef}}
\index{ObitTablePCRef@{ObitTablePCRef}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
returns an Obit\-Table\-PC$\ast$. in = object to reference \index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCRowIsA@{ObitTablePCRowIsA}}
\index{ObitTablePCRowIsA@{ObitTablePCRowIsA}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCRowRef@{ObitTablePCRowRef}}
\index{ObitTablePCRowRef@{ObitTablePCRowRef}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
returns an Obit\-Table\-PCRow$\ast$. in = object to reference \index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCRowUnref@{ObitTablePCRowUnref}}
\index{ObitTablePCRowUnref@{ObitTablePCRowUnref}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-Table\-PCRow\-Unref(in)\ Obit\-Unref (in)}\label{ObitTablePC_8h_a4}


Macro to unreference (and possibly destroy) an {\bf Obit\-Table\-PCRow}{\rm (p.\,\pageref{structObitTablePCRow})} returns an Obit\-Table\-PCRow$\ast$. 

in = object to unreference \index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCUnref@{ObitTablePCUnref}}
\index{ObitTablePCUnref@{ObitTablePCUnref}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!newObitTablePC@{newObitTablePC}}
\index{newObitTablePC@{newObitTablePC}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-PC}$\ast$ new\-Obit\-Table\-PC (gchar $\ast$ {\em name})}\label{ObitTablePC_8h_a11}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!newObitTablePCRow@{newObitTablePCRow}}
\index{newObitTablePCRow@{newObitTablePCRow}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-PCRow}$\ast$ new\-Obit\-Table\-PCRow ({\bf Obit\-Table\-PC} $\ast$ {\em table})}\label{ObitTablePC_8h_a8}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!newObitTablePCValue@{newObitTablePCValue}}
\index{newObitTablePCValue@{newObitTablePCValue}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-PC}$\ast$ new\-Obit\-Table\-PCValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf oint} {\em num\-Pol}, {\bf oint} {\em num\-Band}, {\bf oint} {\em num\-Tones}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTablePC_8h_a12}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCClassInit@{ObitTablePCClassInit}}
\index{ObitTablePCClassInit@{ObitTablePCClassInit}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-PCClass\-Init (void)}\label{ObitTablePC_8h_a10}


Public: Class initializer. 

\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCClone@{ObitTablePCClone}}
\index{ObitTablePCClone@{ObitTablePCClone}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-PC}$\ast$ Obit\-Table\-PCClone ({\bf Obit\-Table\-PC} $\ast$ {\em in}, {\bf Obit\-Table\-PC} $\ast$ {\em out})}\label{ObitTablePC_8h_a15}


Public: Copy (shallow) constructor. 

\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCClose@{ObitTablePCClose}}
\index{ObitTablePCClose@{ObitTablePCClose}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCConvert@{ObitTablePCConvert}}
\index{ObitTablePCConvert@{ObitTablePCConvert}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-PC}$\ast$ Obit\-Table\-PCConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTablePC_8h_a16}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCCopy@{ObitTablePCCopy}}
\index{ObitTablePCCopy@{ObitTablePCCopy}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-PC}$\ast$ Obit\-Table\-PCCopy ({\bf Obit\-Table\-PC} $\ast$ {\em in}, {\bf Obit\-Table\-PC} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTablePC_8h_a14}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCGetClass@{ObitTablePCGetClass}}
\index{ObitTablePCGetClass@{ObitTablePCGetClass}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-PCGet\-Class (void)}\label{ObitTablePC_8h_a13}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCOpen@{ObitTablePCOpen}}
\index{ObitTablePCOpen@{ObitTablePCOpen}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
\end{itemize}
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCReadRow@{ObitTablePCReadRow}}
\index{ObitTablePCReadRow@{ObitTablePCReadRow}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCRowClassInit@{ObitTablePCRowClassInit}}
\index{ObitTablePCRowClassInit@{ObitTablePCRowClassInit}!ObitTablePC.h@{Obit\-Table\-PC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-PCRow\-Class\-Init (void)}\label{ObitTablePC_8h_a7}


Public: Row Class initializer. 

\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCRowGetClass@{ObitTablePCRowGetClass}}
\index{ObitTablePCRowGetClass@{ObitTablePCRowGetClass}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCSetRow@{ObitTablePCSetRow}}
\index{ObitTablePCSetRow@{ObitTablePCSetRow}!ObitTablePC.h@{Obit\-Table\-PC.h}}
...
\end{Desc}
\index{ObitTablePC.h@{Obit\-Table\-PC.h}!ObitTablePCWriteRow@{ObitTablePCWriteRow}}
\index{ObitTablePCWriteRow@{ObitTablePCWriteRow}!ObitTablePC.h@{Obit\-Table\-PC.h}}
