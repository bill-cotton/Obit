\section{Obit\-PBUtil.h File Reference}
\label{ObitPBUtil_8h}\index{ObitPBUtil.h@{ObitPBUtil.h}}
...
\index{ObitPBUtil.h@{Obit\-PBUtil.h}!ObitPBUtilCCCor@{ObitPBUtilCCCor}}
\index{ObitPBUtilCCCor@{ObitPBUtilCCCor}!ObitPBUtil.h@{Obit\-PBUtil.h}}
...
\index{ObitPBUtil.h@{Obit\-PBUtil.h}!ObitPBUtilImageCor@{ObitPBUtilImageCor}}
\index{ObitPBUtilImageCor@{ObitPBUtilImageCor}!ObitPBUtil.h@{Obit\-PBUtil.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-FArray}$\ast$ Obit\-PBUtil\-Image\-Cor ({\bf Obit\-Image} $\ast$ {\em in\-Image}, {\bf olong} $\ast$ {\em in\-Plane}, {\bf olong} {\em nfreq}, {\bf odouble} $\ast$ {\em Freq}, {\bf ofloat} {\em ant\-Size}, {\bf ofloat} {\em pbmin}, {\bf odouble} {\em ref\-Freq}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitPBUtil_8h_a5}
...
\index{ObitPBUtil.h@{Obit\-PBUtil.h}!ObitPBUtilJinc@{ObitPBUtilJinc}}
\index{ObitPBUtilJinc@{ObitPBUtilJinc}!ObitPBUtil.h@{Obit\-PBUtil.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf ofloat} Obit\-PBUtil\-Jinc ({\bf odouble} {\em Angle}, {\bf odouble} {\em Freq}, {\bf ofloat} {\em ant\-Size}, {\bf ofloat} {\em pbmin})}\label{ObitPBUtil_8h_a1}
...
\index{ObitPBUtil.h@{Obit\-PBUtil.h}!ObitPBUtilPntErr@{ObitPBUtilPntErr}}
\index{ObitPBUtilPntErr@{ObitPBUtilPntErr}!ObitPBUtil.h@{Obit\-PBUtil.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf ofloat} Obit\-PBUtil\-Pnt\-Err ({\bf odouble} {\em Angle}, {\bf odouble} {\em Angle\-O}, {\bf ofloat} {\em ant\-Size}, {\bf ofloat} {\em pbmin}, {\bf odouble} {\em Freq})}\label{ObitPBUtil_8h_a3}
...
\index{ObitPBUtil.h@{Obit\-PBUtil.h}!ObitPBUtilPoly@{ObitPBUtilPoly}}
\index{ObitPBUtilPoly@{ObitPBUtilPoly}!ObitPBUtil.h@{Obit\-PBUtil.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf ofloat} Obit\-PBUtil\-Poly ({\bf odouble} {\em Angle}, {\bf odouble} {\em Freq}, {\bf ofloat} {\em pbmin})}\label{ObitPBUtil_8h_a0}
...
\begin{Desc}
\item[Returns:]Fractional antenna power [pbmin, 1] \end{Desc}
\index{ObitPBUtil.h@{Obit\-PBUtil.h}!ObitPBUtilRelPB@{ObitPBUtilRelPB}}
\index{ObitPBUtilRelPB@{ObitPBUtilRelPB}!ObitPBUtil.h@{Obit\-PBUtil.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf ofloat} Obit\-PBUtil\-Rel\-PB ({\bf odouble} {\em Angle}, {\bf olong} {\em nfreq}, {\bf odouble} $\ast$ {\em Freq}, {\bf ofloat} {\em ant\-Size}, {\bf ofloat} {\em pbmin}, {\bf odouble} {\em ref\-Freq})}\label{ObitPBUtil_8h_a2}
