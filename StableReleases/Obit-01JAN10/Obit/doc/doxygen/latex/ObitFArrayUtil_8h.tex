\section{Obit\-FArray\-Util.h File Reference}
\label{ObitFArrayUtil_8h}\index{ObitFArrayUtil.h@{ObitFArrayUtil.h}}
...
This class is for creating contains functions for manipulating a Obit\-FArrays. Except as noted, magic value blanking is supported (OBIT\_\-MAGIC). There are no instances of this \char`\"{}class\char`\"{}

\subsection{Function Documentation}
\index{ObitFArrayUtil.h@{Obit\-FArray\-Util.h}!ObitFArrayUtilConvolve@{ObitFArrayUtilConvolve}}
\index{ObitFArrayUtilConvolve@{ObitFArrayUtilConvolve}!ObitFArrayUtil.h@{Obit\-FArray\-Util.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-FArray}$\ast$ Obit\-FArray\-Util\-Convolve ({\bf Obit\-FArray} $\ast$ {\em in1}, {\bf Obit\-FArray} $\ast$ {\em in2}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitFArrayUtil_8h_a1}
...
\index{ObitFArrayUtil.h@{Obit\-FArray\-Util.h}!ObitFArrayUtilFitCGauss@{ObitFArrayUtilFitCGauss}}
\index{ObitFArrayUtilFitCGauss@{ObitFArrayUtilFitCGauss}!ObitFArrayUtil.h@{Obit\-FArray\-Util.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf ofloat} Obit\-FArray\-Util\-Fit\-CGauss ({\bf Obit\-FArray} $\ast$ {\em in}, {\bf ofloat} $\ast$ {\em FWHM}, {\bf ofloat} $\ast$ {\em center}, {\bf ofloat} $\ast$ {\em peak}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitFArrayUtil_8h_a0}
...
\index{ObitFArrayUtil.h@{Obit\-FArray\-Util.h}!ObitFArrayUtilUVGaus@{ObitFArrayUtilUVGaus}}
\index{ObitFArrayUtilUVGaus@{ObitFArrayUtilUVGaus}!ObitFArrayUtil.h@{Obit\-FArray\-Util.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-FArray}$\ast$ Obit\-FArray\-Util\-UVGaus ({\bf olong} $\ast$ {\em naxis}, {\bf ofloat} $\ast$ {\em cells}, {\bf ofloat} {\em maprot}, {\bf ofloat} {\em Gaumaj}, {\bf ofloat} {\em Gaumin}, {\bf ofloat} {\em Gau\-PA})}\label{ObitFArrayUtil_8h_a2}
