\section{Obit\-Table\-FQUtil.h File Reference}
\label{ObitTableFQUtil_8h}\index{ObitTableFQUtil.h@{ObitTableFQUtil.h}}
...
\index{ObitTableFQUtil.h@{Obit\-Table\-FQUtil.h}!ObitTableFQGetInfo@{ObitTableFQGetInfo}}
\index{ObitTableFQGetInfo@{ObitTableFQGetInfo}!ObitTableFQUtil.h@{Obit\-Table\-FQUtil.h}}
...
\index{ObitTableFQUtil.h@{Obit\-Table\-FQUtil.h}!ObitTableFQPutInfo@{ObitTableFQPutInfo}}
\index{ObitTableFQPutInfo@{ObitTableFQPutInfo}!ObitTableFQUtil.h@{Obit\-Table\-FQUtil.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-Table\-FQPut\-Info ({\bf Obit\-Table\-FQ} $\ast$ {\em in}, {\bf oint} {\em fqid}, {\bf oint} {\em nif}, {\bf odouble} $\ast$ {\em freq\-Off}, {\bf oint} $\ast$ {\em side\-Band}, {\bf ofloat} $\ast$ {\em ch\-Bandw}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableFQUtil_8h_a1}
...
\begin{Desc}
\item[Returns:]I/O Code OBIT\_\-IO\_\-OK = OK. \end{Desc}
\index{ObitTableFQUtil.h@{Obit\-Table\-FQUtil.h}!ObitTableFQSelect@{ObitTableFQSelect}}
\index{ObitTableFQSelect@{ObitTableFQSelect}!ObitTableFQUtil.h@{Obit\-Table\-FQUtil.h}}
