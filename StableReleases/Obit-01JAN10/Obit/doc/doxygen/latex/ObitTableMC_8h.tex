\section{Obit\-Table\-MC.h File Reference}
\label{ObitTableMC_8h}\index{ObitTableMC.h@{ObitTableMC.h}}
...
\subsection{Specifying desired data transfer parameters}\label{ObitTableMC_8h_ObitTableMCSpecification}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!MAXKEYCHARTABLEMC@{MAXKEYCHARTABLEMC}}
\index{MAXKEYCHARTABLEMC@{MAXKEYCHARTABLEMC}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAXKEYCHARTABLEMC\ 24}\label{ObitTableMC_8h_a0}


Number of characters for Table keyword. 

\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCIsA@{ObitTableMCIsA}}
\index{ObitTableMCIsA@{ObitTableMCIsA}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCRef@{ObitTableMCRef}}
\index{ObitTableMCRef@{ObitTableMCRef}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
returns an Obit\-Table\-MC$\ast$. in = object to reference \index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCRowIsA@{ObitTableMCRowIsA}}
\index{ObitTableMCRowIsA@{ObitTableMCRowIsA}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCRowRef@{ObitTableMCRowRef}}
\index{ObitTableMCRowRef@{ObitTableMCRowRef}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
returns an Obit\-Table\-MCRow$\ast$. in = object to reference \index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCRowUnref@{ObitTableMCRowUnref}}
\index{ObitTableMCRowUnref@{ObitTableMCRowUnref}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-Table\-MCRow\-Unref(in)\ Obit\-Unref (in)}\label{ObitTableMC_8h_a4}


Macro to unreference (and possibly destroy) an {\bf Obit\-Table\-MCRow}{\rm (p.\,\pageref{structObitTableMCRow})} returns an Obit\-Table\-MCRow$\ast$. 

in = object to unreference \index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCUnref@{ObitTableMCUnref}}
\index{ObitTableMCUnref@{ObitTableMCUnref}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!newObitTableMC@{newObitTableMC}}
\index{newObitTableMC@{newObitTableMC}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ new\-Obit\-Table\-MC (gchar $\ast$ {\em name})}\label{ObitTableMC_8h_a11}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!newObitTableMCRow@{newObitTableMCRow}}
\index{newObitTableMCRow@{newObitTableMCRow}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MCRow}$\ast$ new\-Obit\-Table\-MCRow ({\bf Obit\-Table\-MC} $\ast$ {\em table})}\label{ObitTableMC_8h_a8}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!newObitTableMCValue@{newObitTableMCValue}}
\index{newObitTableMCValue@{newObitTableMCValue}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ new\-Obit\-Table\-MCValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf oint} {\em num\-Band}, {\bf oint} {\em num\-Pol}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMC_8h_a12}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCClassInit@{ObitTableMCClassInit}}
\index{ObitTableMCClassInit@{ObitTableMCClassInit}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MCClass\-Init (void)}\label{ObitTableMC_8h_a10}


Public: Class initializer. 

\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCClone@{ObitTableMCClone}}
\index{ObitTableMCClone@{ObitTableMCClone}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ Obit\-Table\-MCClone ({\bf Obit\-Table\-MC} $\ast$ {\em in}, {\bf Obit\-Table\-MC} $\ast$ {\em out})}\label{ObitTableMC_8h_a15}


Public: Copy (shallow) constructor. 

\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCClose@{ObitTableMCClose}}
\index{ObitTableMCClose@{ObitTableMCClose}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCConvert@{ObitTableMCConvert}}
\index{ObitTableMCConvert@{ObitTableMCConvert}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ Obit\-Table\-MCConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableMC_8h_a16}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCCopy@{ObitTableMCCopy}}
\index{ObitTableMCCopy@{ObitTableMCCopy}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-MC}$\ast$ Obit\-Table\-MCCopy ({\bf Obit\-Table\-MC} $\ast$ {\em in}, {\bf Obit\-Table\-MC} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableMC_8h_a14}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCGetClass@{ObitTableMCGetClass}}
\index{ObitTableMCGetClass@{ObitTableMCGetClass}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-MCGet\-Class (void)}\label{ObitTableMC_8h_a13}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCOpen@{ObitTableMCOpen}}
\index{ObitTableMCOpen@{ObitTableMCOpen}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
\end{itemize}
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCReadRow@{ObitTableMCReadRow}}
\index{ObitTableMCReadRow@{ObitTableMCReadRow}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCRowClassInit@{ObitTableMCRowClassInit}}
\index{ObitTableMCRowClassInit@{ObitTableMCRowClassInit}!ObitTableMC.h@{Obit\-Table\-MC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-MCRow\-Class\-Init (void)}\label{ObitTableMC_8h_a7}


Public: Row Class initializer. 

\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCRowGetClass@{ObitTableMCRowGetClass}}
\index{ObitTableMCRowGetClass@{ObitTableMCRowGetClass}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCSetRow@{ObitTableMCSetRow}}
\index{ObitTableMCSetRow@{ObitTableMCSetRow}!ObitTableMC.h@{Obit\-Table\-MC.h}}
...
\end{Desc}
\index{ObitTableMC.h@{Obit\-Table\-MC.h}!ObitTableMCWriteRow@{ObitTableMCWriteRow}}
\index{ObitTableMCWriteRow@{ObitTableMCWriteRow}!ObitTableMC.h@{Obit\-Table\-MC.h}}
