\section{Obit\-Table\-CC.h File Reference}
\label{ObitTableCC_8h}\index{ObitTableCC.h@{ObitTableCC.h}}
...
\subsection{Specifying desired data transfer parameters}\label{ObitTableCC_8h_ObitTableCCSpecification}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!MAXKEYCHARTABLECC@{MAXKEYCHARTABLECC}}
\index{MAXKEYCHARTABLECC@{MAXKEYCHARTABLECC}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define MAXKEYCHARTABLECC\ 24}\label{ObitTableCC_8h_a0}


Number of characters for Table keyword. 

\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCIsA@{ObitTableCCIsA}}
\index{ObitTableCCIsA@{ObitTableCCIsA}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCRef@{ObitTableCCRef}}
\index{ObitTableCCRef@{ObitTableCCRef}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
returns an Obit\-Table\-CC$\ast$. in = object to reference \index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCRowIsA@{ObitTableCCRowIsA}}
\index{ObitTableCCRowIsA@{ObitTableCCRowIsA}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
Returns TRUE if a member, else FALSE in = object to reference \index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCRowRef@{ObitTableCCRowRef}}
\index{ObitTableCCRowRef@{ObitTableCCRowRef}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
returns an Obit\-Table\-CCRow$\ast$. in = object to reference \index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCRowUnref@{ObitTableCCRowUnref}}
\index{ObitTableCCRowUnref@{ObitTableCCRowUnref}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}\#define Obit\-Table\-CCRow\-Unref(in)\ Obit\-Unref (in)}\label{ObitTableCC_8h_a4}


Macro to unreference (and possibly destroy) an {\bf Obit\-Table\-CCRow}{\rm (p.\,\pageref{structObitTableCCRow})} returns an Obit\-Table\-CCRow$\ast$. 

in = object to unreference \index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCUnref@{ObitTableCCUnref}}
\index{ObitTableCCUnref@{ObitTableCCUnref}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!newObitTableCC@{newObitTableCC}}
\index{newObitTableCC@{newObitTableCC}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-CC}$\ast$ new\-Obit\-Table\-CC (gchar $\ast$ {\em name})}\label{ObitTableCC_8h_a11}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!newObitTableCCRow@{newObitTableCCRow}}
\index{newObitTableCCRow@{newObitTableCCRow}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-CCRow}$\ast$ new\-Obit\-Table\-CCRow ({\bf Obit\-Table\-CC} $\ast$ {\em table})}\label{ObitTableCC_8h_a8}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!newObitTableCCValue@{newObitTableCCValue}}
\index{newObitTableCCValue@{newObitTableCCValue}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-CC}$\ast$ new\-Obit\-Table\-CCValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf oint} {\em no\-Parms}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableCC_8h_a12}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCClassInit@{ObitTableCCClassInit}}
\index{ObitTableCCClassInit@{ObitTableCCClassInit}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-CCClass\-Init (void)}\label{ObitTableCC_8h_a10}


Public: Class initializer. 

\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCClone@{ObitTableCCClone}}
\index{ObitTableCCClone@{ObitTableCCClone}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-CC}$\ast$ Obit\-Table\-CCClone ({\bf Obit\-Table\-CC} $\ast$ {\em in}, {\bf Obit\-Table\-CC} $\ast$ {\em out})}\label{ObitTableCC_8h_a15}


Public: Copy (shallow) constructor. 

\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCClose@{ObitTableCCClose}}
\index{ObitTableCCClose@{ObitTableCCClose}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCConvert@{ObitTableCCConvert}}
\index{ObitTableCCConvert@{ObitTableCCConvert}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-CC}$\ast$ Obit\-Table\-CCConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableCC_8h_a16}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCCopy@{ObitTableCCCopy}}
\index{ObitTableCCCopy@{ObitTableCCCopy}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-CC}$\ast$ Obit\-Table\-CCCopy ({\bf Obit\-Table\-CC} $\ast$ {\em in}, {\bf Obit\-Table\-CC} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableCC_8h_a14}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCGetClass@{ObitTableCCGetClass}}
\index{ObitTableCCGetClass@{ObitTableCCGetClass}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-CCGet\-Class (void)}\label{ObitTableCC_8h_a13}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCOpen@{ObitTableCCOpen}}
\index{ObitTableCCOpen@{ObitTableCCOpen}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
\end{itemize}
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCReadRow@{ObitTableCCReadRow}}
\index{ObitTableCCReadRow@{ObitTableCCReadRow}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCRowClassInit@{ObitTableCCRowClassInit}}
\index{ObitTableCCRowClassInit@{ObitTableCCRowClassInit}!ObitTableCC.h@{Obit\-Table\-CC.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-CCRow\-Class\-Init (void)}\label{ObitTableCC_8h_a7}


Public: Row Class initializer. 

\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCRowGetClass@{ObitTableCCRowGetClass}}
\index{ObitTableCCRowGetClass@{ObitTableCCRowGetClass}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCSetRow@{ObitTableCCSetRow}}
\index{ObitTableCCSetRow@{ObitTableCCSetRow}!ObitTableCC.h@{Obit\-Table\-CC.h}}
...
\end{Desc}
\index{ObitTableCC.h@{Obit\-Table\-CC.h}!ObitTableCCWriteRow@{ObitTableCCWriteRow}}
\index{ObitTableCCWriteRow@{ObitTableCCWriteRow}!ObitTableCC.h@{Obit\-Table\-CC.h}}
