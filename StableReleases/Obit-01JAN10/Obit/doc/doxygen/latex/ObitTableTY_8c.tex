\section{Obit\-Table\-TY.c File Reference}
\label{ObitTableTY_8c}\index{ObitTableTY.c@{ObitTableTY.c}}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!newObitTableTY@{newObitTableTY}}
\index{newObitTableTY@{newObitTableTY}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-TY}$\ast$ new\-Obit\-Table\-TY (gchar $\ast$ {\em name})}\label{ObitTableTY_8c_a16}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!newObitTableTYRow@{newObitTableTYRow}}
\index{newObitTableTYRow@{newObitTableTYRow}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-TYRow}$\ast$ new\-Obit\-Table\-TYRow ({\bf Obit\-Table\-TY} $\ast$ {\em table})}\label{ObitTableTY_8c_a14}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!newObitTableTYValue@{newObitTableTYValue}}
\index{newObitTableTYValue@{newObitTableTYValue}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-TY}$\ast$ new\-Obit\-Table\-TYValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf oint} {\em num\-Pol}, {\bf oint} {\em num\-IF}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableTY_8c_a18}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYClassInit@{ObitTableTYClassInit}}
\index{ObitTableTYClassInit@{ObitTableTYClassInit}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-TYClass\-Init (void)}\label{ObitTableTY_8c_a27}


Public: Class initializer. 

\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYClear@{ObitTableTYClear}}
\index{ObitTableTYClear@{ObitTableTYClear}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYClose@{ObitTableTYClose}}
\index{ObitTableTYClose@{ObitTableTYClose}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYConvert@{ObitTableTYConvert}}
\index{ObitTableTYConvert@{ObitTableTYConvert}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-TY}$\ast$ Obit\-Table\-TYConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableTY_8c_a19}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYCopy@{ObitTableTYCopy}}
\index{ObitTableTYCopy@{ObitTableTYCopy}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-TY}$\ast$ Obit\-Table\-TYCopy ({\bf Obit\-Table\-TY} $\ast$ {\em in}, {\bf Obit\-Table\-TY} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableTY_8c_a20}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYGetClass@{ObitTableTYGetClass}}
\index{ObitTableTYGetClass@{ObitTableTYGetClass}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYInit@{ObitTableTYInit}}
\index{ObitTableTYInit@{ObitTableTYInit}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-TYInit (gpointer {\em inn})}\label{ObitTableTY_8c_a8}
...
\end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYOpen@{ObitTableTYOpen}}
\index{ObitTableTYOpen@{ObitTableTYOpen}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\end{itemize}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYReadRow@{ObitTableTYReadRow}}
\index{ObitTableTYReadRow@{ObitTableTYReadRow}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYRowClassInit@{ObitTableTYRowClassInit}}
\index{ObitTableTYRowClassInit@{ObitTableTYRowClassInit}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-TYRow\-Class\-Init (void)}\label{ObitTableTY_8c_a26}


Public: Row Class initializer. 

\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYRowClear@{ObitTableTYRowClear}}
\index{ObitTableTYRowClear@{ObitTableTYRowClear}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYRowGetClass@{ObitTableTYRowGetClass}}
\index{ObitTableTYRowGetClass@{ObitTableTYRowGetClass}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-TYRow\-Get\-Class (void)}\label{ObitTableTY_8c_a15}
...
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYRowInit@{ObitTableTYRowInit}}
\index{ObitTableTYRowInit@{ObitTableTYRowInit}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\item[{\em inn}]Pointer to the object to initialize. \end{description}
\end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYSetRow@{ObitTableTYSetRow}}
\index{ObitTableTYSetRow@{ObitTableTYSetRow}!ObitTableTY.c@{Obit\-Table\-TY.c}}
...
\end{Desc}
\index{ObitTableTY.c@{Obit\-Table\-TY.c}!ObitTableTYWriteRow@{ObitTableTYWriteRow}}
\index{ObitTableTYWriteRow@{ObitTableTYWriteRow}!ObitTableTY.c@{Obit\-Table\-TY.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-Table\-TYWrite\-Row ({\bf Obit\-Table\-TY} $\ast$ {\em in}, {\bf olong} {\em i\-TYRow}, {\bf Obit\-Table\-TYRow} $\ast$ {\em row}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableTY_8c_a24}
