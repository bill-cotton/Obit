\section{Obit\-Table\-Util.h File Reference}
\label{ObitTableUtil_8h}\index{ObitTableUtil.h@{ObitTableUtil.h}}
...
\index{ObitTableUtil.h@{Obit\-Table\-Util.h}!ObitTableUtilAbsSort@{ObitTableUtilAbsSort}}
\index{ObitTableUtilAbsSort@{ObitTableUtilAbsSort}!ObitTableUtil.h@{Obit\-Table\-Util.h}}
...
\index{ObitTableUtil.h@{Obit\-Table\-Util.h}!ObitTableUtilSort@{ObitTableUtilSort}}
\index{ObitTableUtilSort@{ObitTableUtilSort}!ObitTableUtil.h@{Obit\-Table\-Util.h}}
...
\begin{Desc}
\item[Returns:]I/O Code OBIT\_\-IO\_\-OK = OK. \end{Desc}
\index{ObitTableUtil.h@{Obit\-Table\-Util.h}!ObitTableUtilSort2f@{ObitTableUtilSort2f}}
\index{ObitTableUtilSort2f@{ObitTableUtilSort2f}!ObitTableUtil.h@{Obit\-Table\-Util.h}}
...
\begin{Desc}
\item[Returns:]I/O Code OBIT\_\-IO\_\-OK = OK. \end{Desc}
\index{ObitTableUtil.h@{Obit\-Table\-Util.h}!ObitTableUtilTruncate@{ObitTableUtilTruncate}}
\index{ObitTableUtilTruncate@{ObitTableUtilTruncate}!ObitTableUtil.h@{Obit\-Table\-Util.h}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-Util\-Truncate ({\bf Obit\-Table} $\ast$ {\em in}, {\bf olong} {\em nrows}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableUtil_8h_a3}
