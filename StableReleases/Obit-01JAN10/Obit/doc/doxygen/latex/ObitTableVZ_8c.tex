\section{Obit\-Table\-VZ.c File Reference}
\label{ObitTableVZ_8c}\index{ObitTableVZ.c@{ObitTableVZ.c}}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!newObitTableVZ@{newObitTableVZ}}
\index{newObitTableVZ@{newObitTableVZ}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-VZ}$\ast$ new\-Obit\-Table\-VZ (gchar $\ast$ {\em name})}\label{ObitTableVZ_8c_a16}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!newObitTableVZRow@{newObitTableVZRow}}
\index{newObitTableVZRow@{newObitTableVZRow}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-VZRow}$\ast$ new\-Obit\-Table\-VZRow ({\bf Obit\-Table\-VZ} $\ast$ {\em table})}\label{ObitTableVZ_8c_a14}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!newObitTableVZValue@{newObitTableVZValue}}
\index{newObitTableVZValue@{newObitTableVZValue}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-VZ}$\ast$ new\-Obit\-Table\-VZValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableVZ_8c_a18}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZClassInit@{ObitTableVZClassInit}}
\index{ObitTableVZClassInit@{ObitTableVZClassInit}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-VZClass\-Init (void)}\label{ObitTableVZ_8c_a27}


Public: Class initializer. 

\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZClear@{ObitTableVZClear}}
\index{ObitTableVZClear@{ObitTableVZClear}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZClose@{ObitTableVZClose}}
\index{ObitTableVZClose@{ObitTableVZClose}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-Table\-VZClose ({\bf Obit\-Table\-VZ} $\ast$ {\em in}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableVZ_8c_a25}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZConvert@{ObitTableVZConvert}}
\index{ObitTableVZConvert@{ObitTableVZConvert}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-VZ}$\ast$ Obit\-Table\-VZConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableVZ_8c_a19}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZCopy@{ObitTableVZCopy}}
\index{ObitTableVZCopy@{ObitTableVZCopy}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-VZ}$\ast$ Obit\-Table\-VZCopy ({\bf Obit\-Table\-VZ} $\ast$ {\em in}, {\bf Obit\-Table\-VZ} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableVZ_8c_a20}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZGetClass@{ObitTableVZGetClass}}
\index{ObitTableVZGetClass@{ObitTableVZGetClass}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZInit@{ObitTableVZInit}}
\index{ObitTableVZInit@{ObitTableVZInit}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-VZInit (gpointer {\em inn})}\label{ObitTableVZ_8c_a8}
...
\end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZOpen@{ObitTableVZOpen}}
\index{ObitTableVZOpen@{ObitTableVZOpen}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\end{itemize}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZReadRow@{ObitTableVZReadRow}}
\index{ObitTableVZReadRow@{ObitTableVZReadRow}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZRowClassInit@{ObitTableVZRowClassInit}}
\index{ObitTableVZRowClassInit@{ObitTableVZRowClassInit}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-VZRow\-Class\-Init (void)}\label{ObitTableVZ_8c_a26}


Public: Row Class initializer. 

\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZRowClear@{ObitTableVZRowClear}}
\index{ObitTableVZRowClear@{ObitTableVZRowClear}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZRowGetClass@{ObitTableVZRowGetClass}}
\index{ObitTableVZRowGetClass@{ObitTableVZRowGetClass}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-VZRow\-Get\-Class (void)}\label{ObitTableVZ_8c_a15}
...
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZRowInit@{ObitTableVZRowInit}}
\index{ObitTableVZRowInit@{ObitTableVZRowInit}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\item[{\em inn}]Pointer to the object to initialize. \end{description}
\end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZSetRow@{ObitTableVZSetRow}}
\index{ObitTableVZSetRow@{ObitTableVZSetRow}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
...
\end{Desc}
\index{ObitTableVZ.c@{Obit\-Table\-VZ.c}!ObitTableVZWriteRow@{ObitTableVZWriteRow}}
\index{ObitTableVZWriteRow@{ObitTableVZWriteRow}!ObitTableVZ.c@{Obit\-Table\-VZ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-Table\-VZWrite\-Row ({\bf Obit\-Table\-VZ} $\ast$ {\em in}, {\bf olong} {\em i\-VZRow}, {\bf Obit\-Table\-VZRow} $\ast$ {\em row}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableVZ_8c_a24}
