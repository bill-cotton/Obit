\section{Obit\-Table\-FQ.c File Reference}
\label{ObitTableFQ_8c}\index{ObitTableFQ.c@{ObitTableFQ.c}}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!newObitTableFQ@{newObitTableFQ}}
\index{newObitTableFQ@{newObitTableFQ}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-FQ}$\ast$ new\-Obit\-Table\-FQ (gchar $\ast$ {\em name})}\label{ObitTableFQ_8c_a16}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!newObitTableFQRow@{newObitTableFQRow}}
\index{newObitTableFQRow@{newObitTableFQRow}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-FQRow}$\ast$ new\-Obit\-Table\-FQRow ({\bf Obit\-Table\-FQ} $\ast$ {\em table})}\label{ObitTableFQ_8c_a14}
...
\begin{Desc}
\item[Returns:]the new object. \end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!newObitTableFQValue@{newObitTableFQValue}}
\index{newObitTableFQValue@{newObitTableFQValue}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-FQ}$\ast$ new\-Obit\-Table\-FQValue (gchar $\ast$ {\em name}, {\bf Obit\-Data} $\ast$ {\em file}, {\bf olong} $\ast$ {\em ver}, Obit\-IOAccess {\em access}, {\bf oint} {\em num\-IF}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableFQ_8c_a18}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQClassInit@{ObitTableFQClassInit}}
\index{ObitTableFQClassInit@{ObitTableFQClassInit}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-FQClass\-Init (void)}\label{ObitTableFQ_8c_a27}


Public: Class initializer. 

\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQClear@{ObitTableFQClear}}
\index{ObitTableFQClear@{ObitTableFQClear}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQClose@{ObitTableFQClose}}
\index{ObitTableFQClose@{ObitTableFQClose}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQConvert@{ObitTableFQConvert}}
\index{ObitTableFQConvert@{ObitTableFQConvert}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-FQ}$\ast$ Obit\-Table\-FQConvert ({\bf Obit\-Table} $\ast$ {\em in})}\label{ObitTableFQ_8c_a19}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQCopy@{ObitTableFQCopy}}
\index{ObitTableFQCopy@{ObitTableFQCopy}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}{\bf Obit\-Table\-FQ}$\ast$ Obit\-Table\-FQCopy ({\bf Obit\-Table\-FQ} $\ast$ {\em in}, {\bf Obit\-Table\-FQ} $\ast$ {\em out}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableFQ_8c_a20}
...
\begin{Desc}
\item[Returns:]pointer to the new object. \end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQGetClass@{ObitTableFQGetClass}}
\index{ObitTableFQGetClass@{ObitTableFQGetClass}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQInit@{ObitTableFQInit}}
\index{ObitTableFQInit@{ObitTableFQInit}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-FQInit (gpointer {\em inn})}\label{ObitTableFQ_8c_a8}
...
\end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQOpen@{ObitTableFQOpen}}
\index{ObitTableFQOpen@{ObitTableFQOpen}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\end{itemize}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQReadRow@{ObitTableFQReadRow}}
\index{ObitTableFQReadRow@{ObitTableFQReadRow}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\begin{Desc}
\item[Returns:]return code, OBIT\_\-IO\_\-OK=$>$ OK \end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQRowClassInit@{ObitTableFQRowClassInit}}
\index{ObitTableFQRowClassInit@{ObitTableFQRowClassInit}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}void Obit\-Table\-FQRow\-Class\-Init (void)}\label{ObitTableFQ_8c_a26}


Public: Row Class initializer. 

\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQRowClear@{ObitTableFQRowClear}}
\index{ObitTableFQRowClear@{ObitTableFQRowClear}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQRowGetClass@{ObitTableFQRowGetClass}}
\index{ObitTableFQRowGetClass@{ObitTableFQRowGetClass}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}gconstpointer Obit\-Table\-FQRow\-Get\-Class (void)}\label{ObitTableFQ_8c_a15}
...
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQRowInit@{ObitTableFQRowInit}}
\index{ObitTableFQRowInit@{ObitTableFQRowInit}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\item[{\em inn}]Pointer to the object to initialize. \end{description}
\end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQSetRow@{ObitTableFQSetRow}}
\index{ObitTableFQSetRow@{ObitTableFQSetRow}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
...
\end{Desc}
\index{ObitTableFQ.c@{Obit\-Table\-FQ.c}!ObitTableFQWriteRow@{ObitTableFQWriteRow}}
\index{ObitTableFQWriteRow@{ObitTableFQWriteRow}!ObitTableFQ.c@{Obit\-Table\-FQ.c}}
\subsubsection{\setlength{\rightskip}{0pt plus 5cm}Obit\-IOCode Obit\-Table\-FQWrite\-Row ({\bf Obit\-Table\-FQ} $\ast$ {\em in}, {\bf olong} {\em i\-FQRow}, {\bf Obit\-Table\-FQRow} $\ast$ {\em row}, {\bf Obit\-Err} $\ast$ {\em err})}\label{ObitTableFQ_8c_a24}
