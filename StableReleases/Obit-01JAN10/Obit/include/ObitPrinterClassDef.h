...
/*--------------------------------------------------------------------*/
/*  Define the basic components of the ObitPrinter ClassInfo structure*/
...
ObitPrinterCreateFP ObitPrinterCreate;
/** Function pointer to Open. */
ObitPrinterOpenFP ObitPrinterOpen;
/** Function pointer to Write. */
ObitPrinterWriteFP ObitPrinterWrite;
/** Function pointer to Open. */
ObitPrinterCloseFP  ObitPrinterClose;
/** Function pointer to SetTitles. */
ObitPrinterSetTitleFP  ObitPrinterSetTitle;
/** Function pointer to NewPage. */
