/* $Id: ObitTableOTFSoln.c 69 2009-01-21 16:00:01Z bill.cotton $  */
...
/**
 * \file ObitTableOTFSoln.c
 * ObitTableOTFSoln class function definitions.
 * This class is derived from the ObitTable class.
 */

/** name of the class defined in this file */
static gchar *myClassName = "ObitTableOTFSoln";
...
static gchar *myRowClassName = "ObitTableOTFSolnRow";
 ...
 */
static ObitTableOTFSolnRowClassInfo myRowClassInfo = {FALSE};

/*------------------  Table  ------------------------*/
/**
 * ClassInfo structure ObitTableOTFSolnClassInfo.
 * This structure is used by class objects to access class functions.
 */
static ObitTableOTFSolnClassInfo myClassInfo = {FALSE};


/*---------------Private function prototypes----------------*/
/** Private: Initialize newly instantiated Row object. */
void  ObitTableOTFSolnRowInit  (gpointer in);

/** Private: Deallocate Row members. */
void  ObitTableOTFSolnRowClear (gpointer in);

/** Private: Initialize newly instantiated object. */
void  ObitTableOTFSolnInit  (gpointer in);

/** Private: Deallocate members. */
void  ObitTableOTFSolnClear (gpointer in);

/** Private: update table specific info */
static void ObitTableOTFSolnUpdate (ObitTableOTFSoln *in, ObitErr *err);

/** Private: copy table keywords to descriptor info list */
static void ObitTableOTFSolnDumpKey (ObitTableOTFSoln *in, ObitErr *err);

/** Private: Set Class function pointers */
static void ObitTableOTFSolnClassInfoDefFn (gpointer inClass);

/** Private: Set Row Class function pointers */
static void ObitTableOTFSolnRowClassInfoDefFn (gpointer inClass);
/*----------------------Public functions---------------------------*/
 ...
 */
ObitTableOTFSolnRow* newObitTableOTFSolnRow (ObitTableOTFSoln *table)
{
  ObitTableOTFSolnRow* out;
  odouble   *dRow;
  oint      *iRow;
  gshort    *siRow;
  ofloat    *fRow;
  ...
  if (!myRowClassInfo.initialized) ObitTableOTFSolnRowClassInit();

  /* allocate/init structure */
  out = g_malloc0(sizeof(ObitTableOTFSolnRow));

  /* initialize values */
  out->name = g_strdup("TableObitTableOTFSoln Row");

  /* set ClassInfo */
  out->ClassInfo = (gpointer)&myRowClassInfo;

  /* initialize other stuff */
  ObitTableOTFSolnRowInit((gpointer)out);
 ...
 * \return the new object.
 */
ObitTableOTFSoln* newObitTableOTFSoln (gchar* name)
{
  ObitTableOTFSoln* out;

  /* Class initialization if needed */
  if (!myClassInfo.initialized) ObitTableOTFSolnClassInit();

  /* allocate/init structure */
  out = g_malloc0(sizeof(ObitTableOTFSoln));
  ...
  /* initialize other stuff */
  ObitTableOTFSolnInit((gpointer)out);

 return out;
} /* end newObitTableOTFSoln */

/**
 * Returns ClassInfo pointer for the class.
 * \return pointer to the class structure.
 */
gconstpointer ObitTableOTFSolnGetClass (void)
{
  /* Class initialization if needed */
  if (!myClassInfo.initialized) ObitTableOTFSolnClassInit();
  return (gconstpointer)&myClassInfo;
} /* end ObitTableOTFSolnGetClass */
 ...
 */
ObitTableOTFSoln* newObitTableOTFSolnValue (gchar* name, ObitData *file, olong *ver,
 				  ObitIOAccess access,
  		     oint numDet, oint numPoly,
		     ObitErr *err)
{
  ObitTableOTFSoln* out=NULL;
  ...
  ObitIOCode retCode;
  gchar *tabType = "OTFSoln";
  gchar *routine = "newObitTableOTFSolnValue";
 ...
 /* error checks */
  ...
  if (*ver>0) { /* has to be specified */
    ...
    if (testTab!=NULL) { /* it exists, use it if is an ObitTableOTFSoln */
      if (ObitTableOTFSolnIsA(testTab)) { /* it is an ObitTableOTFSoln */
	out = ObitTableRef(testTab);
      } else { /* needs conversion */
 	out = ObitTableOTFSolnConvert(testTab);
  ...
  if (access==OBIT_IO_ReadOnly) { 
    highVer = ObitTableListGetHigh (list, "OTFSoln");
  ...
  if (ObitTableOTFSolnIsA(testTab)) { 
    out = ObitTableRef(testTab);
  } else { /* needs conversion */
    out = ObitTableOTFSolnConvert(testTab);
  }
 ...
 return out;
} /* end newObitTableOTFSolnValue */

/**
 * Convert an ObitTable to an ObitTableOTFSoln.
 ...
 */
ObitTableOTFSoln* ObitTableOTFSolnConvert (ObitTable* in)
{
  ObitTableOTFSoln *out;
  ...
  /* create basic object */
  out = newObitTableOTFSoln(in->name);
 ...
 * \return pointer to the new object.
 */
ObitTableOTFSoln* ObitTableOTFSolnCopy (ObitTableOTFSoln *in, ObitTableOTFSoln *out, ObitErr *err)
{
  gchar *routine = "ObitTableOTFSolnCopy";
 ...
 /* error checks */
  ...
  out = (ObitTableOTFSoln*)ObitTableCopy ((ObitTable*)in, (ObitTable*)out, err);
  if (err->error) /* add traceback,return */
  ...
  ObitTableOTFSolnUpdate (out, err);
    
  return out;
} /* end ObitTableOTFSolnCopy */
 ...
 */
ObitIOCode ObitTableOTFSolnOpen (ObitTableOTFSoln *in, ObitIOAccess access, 
			  ObitErr *err)
{
  ObitIOCode retCode = OBIT_IO_SpecErr;
  gint32 dim[MAXINFOELEMDIM] = {1,1,1,1,1};
  olong nRowPIO;
  gchar *routine = "ObitTableOTFSolnOpen";
  ...
  g_assert (ObitIsA(in, &myClassInfo));
   ...
   /* Update class specific info */
   ObitTableOTFSolnUpdate (in, err);
   
   return retCode;
} /* end ObitTableOTFSolnOpen */
 ...
 * \param iOTFSolnRow   Row number, -1 -> next
 * \param row      Table Row structure to receive data
 * \param err ObitErr for reporting errors.
 * \return return code, OBIT_IO_OK=> OK
 */
ObitIOCode 
ObitTableOTFSolnReadRow  (ObitTableOTFSoln *in, olong iOTFSolnRow, ObitTableOTFSolnRow *row,
		     ObitErr *err)
{
  ObitIOCode retCode = OBIT_IO_SpecErr;
  odouble   *dRow;
  ...
  gboolean  *lRow;
  guint8    *bRow;
  gchar *routine = "ObitTableOTFSolnReadRow";
  ...
  if (in->myStatus == OBIT_Inactive) {
    Obit_log_error(err, OBIT_Error,
		   "ObitTableOTFSoln Table is inactive for  %s ", in->name);
    return retCode;
 }

  /* read row iOTFSolnRow */
  retCode = ObitTableRead ((ObitTable*)in, iOTFSolnRow, NULL,  err);
  if (err->error) 
    Obit_traceback_val (err, routine, in->name, retCode);
 ...
 */
void 
ObitTableOTFSolnSetRow  (ObitTableOTFSoln *in, ObitTableOTFSolnRow *row,
		     ObitErr *err)
{
  odouble   *dRow;
  oint      *iRow;
  ...
  if (in->myStatus == OBIT_Inactive) {
    Obit_log_error(err, OBIT_Error,
		   "OTFSoln Table is inactive for  %s ", in->name);
    return;
 }
 ...
 * correct table buffer locations using ObitTableOTFSolnSetRow  
 * \param in       Table to read
 * \param iOTFSolnRow   Row number, -1 -> next
 ...
 */
ObitIOCode 
ObitTableOTFSolnWriteRow  (ObitTableOTFSoln *in, olong iOTFSolnRow, ObitTableOTFSolnRow *row,
		      ObitErr *err)
{
  ObitIOCode retCode = OBIT_IO_SpecErr;
  gshort    *siRow;
  ...
  gboolean  *lRow;
  guint8    *bRow;
  gchar *routine = "ObitTableOTFSolnWriteRow";
  ...
  /* Write row iOTFSolnRow */
  retCode = ObitTableWrite ((ObitTable*)in, iOTFSolnRow, NULL,  err);
  if (err->error) 
    Obit_traceback_val (err, routine,in->name, retCode);

  return retCode;
} /*  end ObitTableOTFSolnWriteRow */
 ...
 */
ObitIOCode ObitTableOTFSolnClose (ObitTableOTFSoln *in, ObitErr *err)
{
  ObitIOCode retCode = OBIT_IO_SpecErr;
  gchar *routine = "ObitTableOTFSolnClose";
  ...
  if (in->myDesc->access != OBIT_IO_ReadOnly) 
    ObitTableOTFSolnDumpKey (in, err);
  if (err->error) 
    Obit_traceback_val (err, routine, in->name, retCode);
  ...
  return retCode;
} /* end ObitTableOTFSolnClose */

/*---------------Private functions--------------------------*/
/*----------------  ObitTableOTFSoln Row  ----------------------*/
/**
 * Creates empty member objects, initialize reference count.
 * Parent classes portions are (recursively) initialized first
 * \param inn Pointer to the object to initialize.
 */
void ObitTableOTFSolnRowInit  (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableOTFSolnRow *in = inn;
 ...
 *           Actually it should be an ObitTableOTFSolnRow* cast to an Obit*.
 */
void ObitTableOTFSolnRowClear (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableOTFSolnRow *in = inn;
...
} /* end ObitTableOTFSolnRowClear */

/**
 * Initialize global ClassInfo Structure.
 */
void ObitTableOTFSolnRowClassInit (void)
{
  ...
  ObitTableOTFSolnRowClassInfoDefFn ((gpointer)&myRowClassInfo);
 
  myRowClassInfo.initialized = TRUE; /* Now initialized */
 
} /* end ObitTableOTFSolnRowClassInit */
...
static void ObitTableOTFSolnRowClassInfoDefFn (gpointer inClass)
{
  ObitTableOTFSolnRowClassInfo *theClass = (ObitTableOTFSolnRowClassInfo*)inClass;
  ...
  theClass->ObitClassInit = (ObitClassInitFP)ObitTableOTFSolnRowClassInit;
  theClass->ObitClassInfoDefFn = (ObitClassInfoDefFnFP)ObitTableOTFSolnRowClassInfoDefFn;
  theClass->ObitGetClass  = (ObitGetClassFP)ObitTableOTFSolnRowGetClass;
  theClass->newObit         = NULL;
  theClass->newObitTableRow = (newObitTableRowFP)newObitTableOTFSolnRow;
  theClass->ObitCopy        = NULL;
  theClass->ObitClone       = NULL;
  theClass->ObitClear       = (ObitClearFP)ObitTableOTFSolnRowClear;
  theClass->ObitInit        = (ObitInitFP)ObitTableOTFSolnRowInit;

} /* end ObitTableOTFSolnRowClassDefFn */
 ...
 * \param inn Pointer to the object to initialize.
 */
void ObitTableOTFSolnInit  (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableOTFSoln *in = inn;
 ...
 * For some reason this wasn't build into the GType class.
 * \param  inn Pointer to the object to deallocate.
 *           Actually it should be an ObitTableOTFSoln* cast to an Obit*.
 */
void ObitTableOTFSolnClear (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableOTFSoln *in = inn;
...
} /* end ObitTableOTFSolnClear */

/**
 * Initialize global ClassInfo Structure.
 */
void ObitTableOTFSolnClassInit (void)
{
  ...
  /* Set function pointers */
  ObitTableOTFSolnClassInfoDefFn ((gpointer)&myClassInfo);
 
  myClassInfo.initialized = TRUE; /* Now initialized */
 
} /* end ObitTableOTFSolnClassInit */
...
static void ObitTableOTFSolnClassInfoDefFn (gpointer inClass)
{
  ObitTableOTFSolnClassInfo *theClass = (ObitTableOTFSolnClassInfo*)inClass;
  ...
  /* function pointers defined or overloaded this class */
  theClass->ObitClassInit = (ObitClassInitFP)ObitTableOTFSolnClassInit;
  theClass->ObitClassInfoDefFn = (ObitClassInfoDefFnFP)ObitTableOTFSolnClassInfoDefFn;
  theClass->ObitGetClass  = (ObitGetClassFP)ObitTableOTFSolnGetClass;
  theClass->newObit       = (newObitFP)newObitTableOTFSoln;
  theClass->ObitCopy      = (ObitCopyFP)ObitTableOTFSolnCopy;
  theClass->ObitClone     = (ObitCloneFP)ObitTableClone;
  theClass->ObitClear     = (ObitClearFP)ObitTableOTFSolnClear;
  theClass->ObitInit      = (ObitInitFP)ObitTableOTFSolnInit;
  theClass->ObitTableConvert = (ObitTableConvertFP)ObitTableOTFSolnConvert;
  theClass->ObitTableOpen    = (ObitTableOpenFP)ObitTableOTFSolnOpen;
  theClass->ObitTableClose   = (ObitTableCloseFP)ObitTableOTFSolnClose;
  ...
  theClass->ObitTableReadRow = 
    (ObitTableReadRowFP)ObitTableOTFSolnReadRow;
  theClass->ObitTableWriteRow = 
    (ObitTableWriteRowFP)ObitTableOTFSolnWriteRow;

} /* end ObitTableOTFSolnClassDefFn */
...
static void ObitTableOTFSolnUpdate (ObitTableOTFSoln *in, ObitErr *err)
{
 ...
 /* error checks */
  ...
  Obit_return_if_fail((in->TimeOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column Time");
  Obit_return_if_fail((in->TimeIOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column TimeI");
  Obit_return_if_fail((in->TargetOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column Target");
  Obit_return_if_fail((in->dAzOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column dAz");
  Obit_return_if_fail((in->dElOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column dEl");
  Obit_return_if_fail((in->calOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column cal");
  Obit_return_if_fail((in->addOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column add");
  Obit_return_if_fail((in->multOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column mult");
  Obit_return_if_fail((in->wtOff > -1), err,
       "ObitTableOTFSolnUpdate: Could not find column wt");
} /* end ObitTableOTFSolnUpdate */
