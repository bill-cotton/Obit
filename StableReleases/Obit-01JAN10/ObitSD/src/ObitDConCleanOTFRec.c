/* $Id: ObitDConCleanOTFRec.c 128 2009-09-23 14:48:29Z bill.cotton $ */
/*--------------------------------------------------------------------*/
...
void ObitDConCleanOTFRecSub(ObitDConClean *inn, ObitErr *err)
{
  ...
  /* Copy */
  RawBeam = ObitFArrayCopy(in->BeamPatches[0], RawBeam, err);
				   ...
				   ObitErr *err)
{
  ...
  /* Load PxList */
  ObitDConCleanPxListUpdate (in->Pixels, in->currentFields, 0, 0.0, in->autoWinFlux,
