/* $Id: ObitTableGBTDCRDATA.h 69 2009-01-21 16:00:01Z bill.cotton $  */
...
/*--------------------------------------------------------------------*/
#ifndef ObitTableGBTDCRDATA_H 
#define ObitTableGBTDCRDATA_H 
...
/**
 * \file ObitTableGBTDCRDATA.h
 * ObitTableGBTDCRDATA class definition.
 *
 ...
 * This class contains tabular data and allows access.
 * ObitTableGBTDCRDATA" 
 * An ObitTableGBTDCRDATA is the front end to a persistent disk resident structure.
 * This class is derived from the ObitTable class.
 *
 ...
 *
 * \section ObitTableGBTDCRDATASpecification Specifying desired data transfer parameters
 ...
 * The convenience Macro #ObitTableGBTDCRDATASetFITS simplifies specifying the 
 * desired data.
 ...
 *
 *
 * \section ObitTableGBTDCRDATAaccess Creators and Destructors
 * An ObitTableGBTDCRDATA can be created using newObitTableGBTDCRDATAValue which attaches the 
 * table to an ObitData for the object.  
 * If the output ObitTableGBTDCRDATA has previously been specified, including file information,
 * then ObitTableGBTDCRDATACopy will copy the disk resident as well as the memory 
 * resident information.
 *
 * A copy of a pointer to an ObitTableGBTDCRDATA should always be made using the
 * ObitTableGBTDCRDATARef function which updates the reference count in the object.
 * Then whenever freeing an ObitTableGBTDCRDATA or changing a pointer, the function
 * ObitTableGBTDCRDATAUnref will decrement the reference count and destroy the object
 * when the reference count hits 0.
 *
 * \section ObitTableGBTDCRDATAUsage I/O
 * Visibility data is available after an input object is "Opened"
 * and "Read".
 * I/O optionally uses a buffer attached to the ObitTableGBTDCRDATA or some external
 * location.
 * To Write an ObitTableGBTDCRDATA, create it, open it, and write.
 * The object should be closed to ensure all data is flushed to disk.
 * Deletion of an ObitTableGBTDCRDATA after its final unreferencing will automatically
 * close it.
 */
...
typedef struct {
#include "ObitTableGBTDCRDATADef.h"   /* this class definition */
} ObitTableGBTDCRDATA;

/** ObitTableGBTDCRDATARow Class structure. */
typedef struct {
#include "ObitTableGBTDCRDATARowDef.h"   /* this class row definition */
} ObitTableGBTDCRDATARow;

/*----------------- Macroes ---------------------------*/
/** 
 * Macro to unreference (and possibly destroy) an ObitTableGBTDCRDATA
 * returns an ObitTableGBTDCRDATA*.
 * in = object to unreference
 */
#define ObitTableGBTDCRDATAUnref(in) ObitUnref (in)

/** 
 * Macro to reference (update reference count) an ObitTableGBTDCRDATA.
 * returns an ObitTableGBTDCRDATA*.
 * in = object to reference
 */
#define ObitTableGBTDCRDATARef(in) ObitRef (in)
 ...
 * in = object to reference
 */
#define ObitTableGBTDCRDATAIsA(in) ObitIsA (in, ObitTableGBTDCRDATAGetClass())

/** 
 * Macro to unreference (and possibly destroy) an ObitTableGBTDCRDATARow
 * returns an ObitTableGBTDCRDATARow*.
 * in = object to unreference
 */
#define ObitTableGBTDCRDATARowUnref(in) ObitUnref (in)

/** 
 * Macro to reference (update reference count) an ObitTableGBTDCRDATARow.
 * returns an ObitTableGBTDCRDATARow*.
 * in = object to reference
 */
#define ObitTableGBTDCRDATARowRef(in) ObitRef (in)
 ...
 * in = object to reference
 */
#define ObitTableGBTDCRDATARowIsA(in) ObitIsA (in, ObitTableGBTDCRDATARowGetClass())
...
ObitTableGBTDCRDATA* 
newObitTableGBTDCRDATAValue (gchar* name, ObitData *file, olong *ver,
  		     ObitIOAccess access,
...
ObitTableGBTDCRDATA* ObitTableGBTDCRDATACopy  (ObitTableGBTDCRDATA *in, ObitTableGBTDCRDATA *out, 
			   ObitErr *err);

/** Public: Copy (shallow) constructor. */
ObitTableGBTDCRDATA* ObitTableGBTDCRDATAClone (ObitTableGBTDCRDATA *in, ObitTableGBTDCRDATA *out);

/** Public: Convert an ObitTable to an ObitTableGBTDCRDATA */
 ...
 */
typedef struct  {
#include "ObitTableGBTDCRDATAClassDef.h"
} ObitTableGBTDCRDATAClassInfo; 

/**
 * ClassInfo Structure For TableObitTableGBTDCRDATARow.
 * Contains class name, a pointer to any parent class
 * (NULL if none) and function pointers.
 */
typedef struct  {
#include "ObitTableGBTDCRDATARowClassDef.h"
} ObitTableGBTDCRDATARowClassInfo; 
#endif /* ObitTableGBTDCRDATA_H */ 
