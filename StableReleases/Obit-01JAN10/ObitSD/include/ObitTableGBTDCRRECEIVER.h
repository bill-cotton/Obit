/* $Id: ObitTableGBTDCRRECEIVER.h 69 2009-01-21 16:00:01Z bill.cotton $  */
...
/*--------------------------------------------------------------------*/
#ifndef ObitTableGBTDCRRECEIVER_H 
#define ObitTableGBTDCRRECEIVER_H 
...
/**
 * \file ObitTableGBTDCRRECEIVER.h
 * ObitTableGBTDCRRECEIVER class definition.
 *
 ...
 * An ObitTableGBTDCRRECEIVER is the front end to a persistent disk resident structure.
 * This class is derived from the ObitTable class.
 *
 ...
 *
 * \section ObitTableGBTDCRRECEIVERSpecification Specifying desired data transfer parameters
 ...
 * The convenience Macro #ObitTableGBTDCRRECEIVERSetFITS simplifies specifying the 
 * desired data.
 ...
 *
 *
 * \section ObitTableGBTDCRRECEIVERaccess Creators and Destructors
 * An ObitTableGBTDCRRECEIVER can be created using newObitTableGBTDCRRECEIVERValue which attaches the 
 * table to an ObitData for the object.  
 * If the output ObitTableGBTDCRRECEIVER has previously been specified, including file information,
 * then ObitTableGBTDCRRECEIVERCopy will copy the disk resident as well as the memory 
 * resident information.
 *
 * A copy of a pointer to an ObitTableGBTDCRRECEIVER should always be made using the
 * ObitTableGBTDCRRECEIVERRef function which updates the reference count in the object.
 * Then whenever freeing an ObitTableGBTDCRRECEIVER or changing a pointer, the function
 * ObitTableGBTDCRRECEIVERUnref will decrement the reference count and destroy the object
 * when the reference count hits 0.
 *
 * \section ObitTableGBTDCRRECEIVERUsage I/O
 * Visibility data is available after an input object is "Opened"
 * and "Read".
 * I/O optionally uses a buffer attached to the ObitTableGBTDCRRECEIVER or some external
 * location.
 * To Write an ObitTableGBTDCRRECEIVER, create it, open it, and write.
 * The object should be closed to ensure all data is flushed to disk.
 * Deletion of an ObitTableGBTDCRRECEIVER after its final unreferencing will automatically
 * close it.
 */
...
/** ObitTableGBTDCRRECEIVER Class structure. */
typedef struct {
#include "ObitTableGBTDCRRECEIVERDef.h"   /* this class definition */
} ObitTableGBTDCRRECEIVER;

/** ObitTableGBTDCRRECEIVERRow Class structure. */
typedef struct {
#include "ObitTableGBTDCRRECEIVERRowDef.h"   /* this class row definition */
} ObitTableGBTDCRRECEIVERRow;

/*----------------- Macroes ---------------------------*/
/** 
 * Macro to unreference (and possibly destroy) an ObitTableGBTDCRRECEIVER
 * returns an ObitTableGBTDCRRECEIVER*.
 * in = object to unreference
 */
#define ObitTableGBTDCRRECEIVERUnref(in) ObitUnref (in)

/** 
 * Macro to reference (update reference count) an ObitTableGBTDCRRECEIVER.
 * returns an ObitTableGBTDCRRECEIVER*.
 * in = object to reference
 */
#define ObitTableGBTDCRRECEIVERRef(in) ObitRef (in)
 ...
 * in = object to reference
 */
#define ObitTableGBTDCRRECEIVERIsA(in) ObitIsA (in, ObitTableGBTDCRRECEIVERGetClass())

/** 
 * Macro to unreference (and possibly destroy) an ObitTableGBTDCRRECEIVERRow
 * returns an ObitTableGBTDCRRECEIVERRow*.
 * in = object to unreference
 */
#define ObitTableGBTDCRRECEIVERRowUnref(in) ObitUnref (in)

/** 
 * Macro to reference (update reference count) an ObitTableGBTDCRRECEIVERRow.
 * returns an ObitTableGBTDCRRECEIVERRow*.
 * in = object to reference
 */
#define ObitTableGBTDCRRECEIVERRowRef(in) ObitRef (in)
 ...
 * in = object to reference
 */
#define ObitTableGBTDCRRECEIVERRowIsA(in) ObitIsA (in, ObitTableGBTDCRRECEIVERRowGetClass())
...
ObitTableGBTDCRRECEIVER* 
newObitTableGBTDCRRECEIVERValue (gchar* name, ObitData *file, olong *ver,
  		     ObitIOAccess access,
...
ObitTableGBTDCRRECEIVER* ObitTableGBTDCRRECEIVERCopy  (ObitTableGBTDCRRECEIVER *in, ObitTableGBTDCRRECEIVER *out, 
			   ObitErr *err);

/** Public: Copy (shallow) constructor. */
ObitTableGBTDCRRECEIVER* ObitTableGBTDCRRECEIVERClone (ObitTableGBTDCRRECEIVER *in, ObitTableGBTDCRRECEIVER *out);

/** Public: Convert an ObitTable to an ObitTableGBTDCRRECEIVER */
 ...
 */
typedef struct  {
#include "ObitTableGBTDCRRECEIVERClassDef.h"
} ObitTableGBTDCRRECEIVERClassInfo; 

/**
 * ClassInfo Structure For TableObitTableGBTDCRRECEIVERRow.
 * Contains class name, a pointer to any parent class
 * (NULL if none) and function pointers.
 */
typedef struct  {
#include "ObitTableGBTDCRRECEIVERRowClassDef.h"
} ObitTableGBTDCRRECEIVERRowClassInfo; 
#endif /* ObitTableGBTDCRRECEIVER_H */ 
