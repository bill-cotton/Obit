...
/*--------------------------------------------------------------------*/
#ifndef ObitTableGBTQUADDETECTOR_H 
#define ObitTableGBTQUADDETECTOR_H 
...
/**
 * \file ObitTableGBTQUADDETECTOR.h
 * ObitTableGBTQUADDETECTOR class definition.
 *
 ...
 * An ObitTableGBTQUADDETECTOR is the front end to a persistent disk resident structure.
 * This class is derived from the ObitTable class.
 *
 ...
 *
 * \section ObitTableGBTQUADDETECTORSpecification Specifying desired data transfer parameters
 ...
 * The convenience Macro #ObitTableGBTQUADDETECTORSetFITS simplifies specifying the 
 * desired data.
 ...
 *
 *
 * \section ObitTableGBTQUADDETECTORaccess Creators and Destructors
 * An ObitTableGBTQUADDETECTOR can be created using newObitTableGBTQUADDETECTORValue which attaches the 
 * table to an ObitData for the object.  
 * If the output ObitTableGBTQUADDETECTOR has previously been specified, including file information,
 * then ObitTableGBTQUADDETECTORCopy will copy the disk resident as well as the memory 
 * resident information.
 *
 * A copy of a pointer to an ObitTableGBTQUADDETECTOR should always be made using the
 * ObitTableGBTQUADDETECTORRef function which updates the reference count in the object.
 * Then whenever freeing an ObitTableGBTQUADDETECTOR or changing a pointer, the function
 * ObitTableGBTQUADDETECTORUnref will decrement the reference count and destroy the object
 * when the reference count hits 0.
 *
 * \section ObitTableGBTQUADDETECTORUsage I/O
 * Visibility data is available after an input object is "Opened"
 * and "Read".
 * I/O optionally uses a buffer attached to the ObitTableGBTQUADDETECTOR or some external
 * location.
 * To Write an ObitTableGBTQUADDETECTOR, create it, open it, and write.
 * The object should be closed to ensure all data is flushed to disk.
 * Deletion of an ObitTableGBTQUADDETECTOR after its final unreferencing will automatically
 * close it.
 */
...
/** Number of characters for Table keyword */
 #define MAXKEYCHARTABLEQuadrantDetectorData 24

/** ObitTableGBTQUADDETECTOR Class structure. */
typedef struct {
#include "ObitTableGBTQUADDETECTORDef.h"   /* this class definition */
} ObitTableGBTQUADDETECTOR;

/** ObitTableGBTQUADDETECTORRow Class structure. */
typedef struct {
#include "ObitTableGBTQUADDETECTORRowDef.h"   /* this class row definition */
} ObitTableGBTQUADDETECTORRow;

/*----------------- Macroes ---------------------------*/
/** 
 * Macro to unreference (and possibly destroy) an ObitTableGBTQUADDETECTOR
 * returns an ObitTableGBTQUADDETECTOR*.
 * in = object to unreference
 */
#define ObitTableGBTQUADDETECTORUnref(in) ObitUnref (in)

/** 
 * Macro to reference (update reference count) an ObitTableGBTQUADDETECTOR.
 * returns an ObitTableGBTQUADDETECTOR*.
 * in = object to reference
 */
#define ObitTableGBTQUADDETECTORRef(in) ObitRef (in)
 ...
 * in = object to reference
 */
#define ObitTableGBTQUADDETECTORIsA(in) ObitIsA (in, ObitTableGBTQUADDETECTORGetClass())

/** 
 * Macro to unreference (and possibly destroy) an ObitTableGBTQUADDETECTORRow
 * returns an ObitTableGBTQUADDETECTORRow*.
 * in = object to unreference
 */
#define ObitTableGBTQUADDETECTORRowUnref(in) ObitUnref (in)

/** 
 * Macro to reference (update reference count) an ObitTableGBTQUADDETECTORRow.
 * returns an ObitTableGBTQUADDETECTORRow*.
 * in = object to reference
 */
#define ObitTableGBTQUADDETECTORRowRef(in) ObitRef (in)
 ...
 * in = object to reference
 */
#define ObitTableGBTQUADDETECTORRowIsA(in) ObitIsA (in, ObitTableGBTQUADDETECTORRowGetClass())
...
ObitTableGBTQUADDETECTOR* 
newObitTableGBTQUADDETECTORValue (gchar* name, ObitData *file, olong *ver,
  		     ObitIOAccess access,
...
ObitTableGBTQUADDETECTOR* ObitTableGBTQUADDETECTORCopy  (ObitTableGBTQUADDETECTOR *in, ObitTableGBTQUADDETECTOR *out, 
			   ObitErr *err);

/** Public: Copy (shallow) constructor. */
ObitTableGBTQUADDETECTOR* ObitTableGBTQUADDETECTORClone (ObitTableGBTQUADDETECTOR *in, ObitTableGBTQUADDETECTOR *out);

/** Public: Convert an ObitTable to an ObitTableGBTQUADDETECTOR */
 ...
 */
typedef struct  {
#include "ObitTableGBTQUADDETECTORClassDef.h"
} ObitTableGBTQUADDETECTORClassInfo; 

/**
 * ClassInfo Structure For TableObitTableGBTQUADDETECTORRow.
 * Contains class name, a pointer to any parent class
 * (NULL if none) and function pointers.
 */
typedef struct  {
#include "ObitTableGBTQUADDETECTORRowClassDef.h"
} ObitTableGBTQUADDETECTORRowClassInfo; 
#endif /* ObitTableGBTQUADDETECTOR_H */ 
