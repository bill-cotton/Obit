...
#define MAXNUMVEGASSTATE 10
/** blanking time */
odouble  blanktim[MAXNUMVEGASSTATE];
/** Phase of start of state(?) */
odouble  phsestrt[MAXNUMVEGASSTATE];
/** signal or ref (logical) */
oint  sigref[MAXNUMVEGASSTATE];
/** cal on/off (logical) */
oint  cal[MAXNUMVEGASSTATE];
/** Number of states */
olong nVEGASState;
