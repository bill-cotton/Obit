...
/**
 * \file ObitTableGBTPARDATA2.c
 * ObitTableGBTPARDATA2 class function definitions.
 * This class is derived from the ObitTable class.
 */

/** name of the class defined in this file */
static gchar *myClassName = "ObitTableGBTPARDATA2";
...
static gchar *myRowClassName = "ObitTableGBTPARDATA2Row";
 ...
 */
static ObitTableGBTPARDATA2RowClassInfo myRowClassInfo = {FALSE};

/*------------------  Table  ------------------------*/
/**
 * ClassInfo structure ObitTableGBTPARDATA2ClassInfo.
 * This structure is used by class objects to access class functions.
 */
static ObitTableGBTPARDATA2ClassInfo myClassInfo = {FALSE};


/*---------------Private function prototypes----------------*/
/** Private: Initialize newly instantiated Row object. */
void  ObitTableGBTPARDATA2RowInit  (gpointer in);

/** Private: Deallocate Row members. */
void  ObitTableGBTPARDATA2RowClear (gpointer in);

/** Private: Initialize newly instantiated object. */
void  ObitTableGBTPARDATA2Init  (gpointer in);

/** Private: Deallocate members. */
void  ObitTableGBTPARDATA2Clear (gpointer in);

/** Private: update table specific info */
static void ObitTableGBTPARDATA2Update (ObitTableGBTPARDATA2 *in, ObitErr *err);

/** Private: copy table keywords to descriptor info list */
static void ObitTableGBTPARDATA2DumpKey (ObitTableGBTPARDATA2 *in, ObitErr *err);

/** Private: Set Class function pointers */
static void ObitTableGBTPARDATA2ClassInfoDefFn (gpointer inClass);

/** Private: Set Row Class function pointers */
static void ObitTableGBTPARDATA2RowClassInfoDefFn (gpointer inClass);
/*----------------------Public functions---------------------------*/
...
ObitTableGBTPARDATA2Row* newObitTableGBTPARDATA2Row (ObitTableGBTPARDATA2 *table)
{
  ...
  if (!myRowClassInfo.initialized) ObitTableGBTPARDATA2RowClassInit();

  /* allocate/init structure */
  out = g_malloc0(sizeof(ObitTableGBTPARDATA2Row));

  /* initialize values */
  out->name = g_strdup("TableObitTableGBTPARDATA2 Row");

  /* set ClassInfo */
  out->ClassInfo = (gpointer)&myRowClassInfo;

  /* initialize other stuff */
  ObitTableGBTPARDATA2RowInit((gpointer)out);
  ...
  if ((table->buffer) && (table->myDesc->access != OBIT_IO_ReadOnly) &&
    ...
    out->daccounts = fRow + table->daccountsOff;
    out->saecounts = fRow + table->saecountsOff;
...
} /* end ObitTableGBTPARDATA2RowGetClass */
...
{
  ObitTableGBTPARDATA2* out;

  /* Class initialization if needed */
  if (!myClassInfo.initialized) ObitTableGBTPARDATA2ClassInit();

  /* allocate/init structure */
  out = g_malloc0(sizeof(ObitTableGBTPARDATA2));
  ...
  /* initialize other stuff */
  ObitTableGBTPARDATA2Init((gpointer)out);

 return out;
} /* end newObitTableGBTPARDATA2 */
...
} /* end ObitTableGBTPARDATA2GetClass */
 ...
 */
ObitTableGBTPARDATA2* newObitTableGBTPARDATA2Value (gchar* name, ObitData *file, olong *ver,
 				  ObitIOAccess access,
  		    
		     ObitErr *err)
{
  ObitTableGBTPARDATA2* out=NULL;
  ...
  ObitIOCode retCode;
  gchar *tabType = "DATA";
  gchar *routine = "newObitTableGBTPARDATA2Value";
 ...
 /* error checks */
  ...
  if (*ver>0) { /* has to be specified */
    ...
    if (testTab!=NULL) { /* it exists, use it if is an ObitTableGBTPARDATA2 */
      if (ObitTableGBTPARDATA2IsA(testTab)) { /* it is an ObitTableGBTPARDATA2 */
	out = ObitTableRef(testTab);
      } else { /* needs conversion */
 	out = ObitTableGBTPARDATA2Convert(testTab);
  ...
  if (ObitTableGBTPARDATA2IsA(testTab)) { 
    out = ObitTableRef(testTab);
  } else { /* needs conversion */
    out = ObitTableGBTPARDATA2Convert(testTab);
  }
 ...
 return out;
} /* end newObitTableGBTPARDATA2Value */

/**
 * Convert an ObitTable to an ObitTableGBTPARDATA2.
...
ObitTableGBTPARDATA2* ObitTableGBTPARDATA2Convert (ObitTable* in)
{
  ...
  /* create basic object */
  out = newObitTableGBTPARDATA2(in->name);
 ...
 out->myHost  = in->myHost;
  ...
  return out;
} /* end ObitTableGBTPARDATA2Convert */
 ...
 * \return pointer to the new object.
 */
ObitTableGBTPARDATA2* ObitTableGBTPARDATA2Copy (ObitTableGBTPARDATA2 *in, ObitTableGBTPARDATA2 *out, ObitErr *err)
{
  gchar *routine = "ObitTableGBTPARDATA2Copy";
 ...
 /* error checks */
  ...
  out = (ObitTableGBTPARDATA2*)ObitTableCopy ((ObitTable*)in, (ObitTable*)out, err);
  if (err->error) /* add traceback,return */
  ...
  ObitTableGBTPARDATA2Update (out, err);
    
  return out;
} /* end ObitTableGBTPARDATA2Copy */
			  ...
			  ObitErr *err)
{
  ...
  olong nRowPIO;
  gchar *routine = "ObitTableGBTPARDATA2Open";
  ...
  g_assert (ObitIsA(in, &myClassInfo));
   ...
   /* Update class specific info */
   ObitTableGBTPARDATA2Update (in, err);
   
   return retCode;
} /* end ObitTableGBTPARDATA2Open */
		     ...
		     ObitErr *err)
{
  ...
  gboolean  *lRow;
  guint8    *bRow;
  gchar *routine = "ObitTableGBTPARDATA2ReadRow";
  ...
  if (in->myStatus == OBIT_Inactive) {
    Obit_log_error(err, OBIT_Error,
		   "ObitTableGBTPARDATA2 Table is inactive for  %s ", in->name);
    return retCode;
 }
  ...
  row->daccounts = fRow + in->daccountsOff;
  row->saecounts = fRow + in->saecountsOff;
  row->DigInput = bRow + in->DigInputOff;
  row->status = iRow[in->myDesc->statusOff];

  return retCode;
} /*  end ObitTableGBTPARDATA2ReadRow */
...
} /*  end ObitTableGBTPARDATA2SetRow */
 ...
 * correct table buffer locations using ObitTableGBTPARDATA2SetRow  
 * \param in       Table to read
 * \param iDATARow   Row number, -1 -> next
		      ...
		      ObitErr *err)
{
  ...
  gboolean  *lRow;
  guint8    *bRow;
  gchar *routine = "ObitTableGBTPARDATA2WriteRow";
  ...
  if (in->daccountsCol >= 0) { 
    for (i=0; i<in->myDesc->repeat[in->daccountsCol]; i++) 
      fRow[in->daccountsOff+i] = row->daccounts[i];
  } 
  if (in->saecountsCol >= 0) { 
    for (i=0; i<in->myDesc->repeat[in->saecountsCol]; i++) 
      fRow[in->saecountsOff+i] = row->saecounts[i];
  } 
  if (in->DigInputCol >= 0) { 
  ...
  return retCode;
} /*  end ObitTableGBTPARDATA2WriteRow */
...
{
  ObitIOCode retCode = OBIT_IO_SpecErr;
  gchar *routine = "ObitTableGBTPARDATA2Close";
  ...
  if (in->myDesc->access != OBIT_IO_ReadOnly) 
    ObitTableGBTPARDATA2DumpKey (in, err);
  if (err->error) 
    Obit_traceback_val (err, routine, in->name, retCode);
  ...
  return retCode;
} /* end ObitTableGBTPARDATA2Close */

/*---------------Private functions--------------------------*/
/*----------------  ObitTableGBTPARDATA2 Row  ----------------------*/
/**
 * Creates empty member objects, initialize reference count.
 * Parent classes portions are (recursively) initialized first
 * \param inn Pointer to the object to initialize.
 */
void ObitTableGBTPARDATA2RowInit  (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableGBTPARDATA2Row *in = inn;
...
} /* end ObitTableGBTPARDATA2RowInit */
 ...
 *           Actually it should be an ObitTableGBTPARDATA2Row* cast to an Obit*.
 */
void ObitTableGBTPARDATA2RowClear (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableGBTPARDATA2Row *in = inn;
...
} /* end ObitTableGBTPARDATA2RowClear */
...
void ObitTableGBTPARDATA2RowClassInit (void)
{
  ...
  ObitTableGBTPARDATA2RowClassInfoDefFn ((gpointer)&myRowClassInfo);
 
  myRowClassInfo.initialized = TRUE; /* Now initialized */
 
} /* end ObitTableGBTPARDATA2RowClassInit */
...
static void ObitTableGBTPARDATA2RowClassInfoDefFn (gpointer inClass)
{
  ObitTableGBTPARDATA2RowClassInfo *theClass = (ObitTableGBTPARDATA2RowClassInfo*)inClass;
  ...
  theClass->ObitClassInit = (ObitClassInitFP)ObitTableGBTPARDATA2RowClassInit;
  theClass->ObitClassInfoDefFn = (ObitClassInfoDefFnFP)ObitTableGBTPARDATA2RowClassInfoDefFn;
  theClass->ObitGetClass  = (ObitGetClassFP)ObitTableGBTPARDATA2RowGetClass;
  theClass->newObit         = NULL;
  theClass->newObitTableRow = (newObitTableRowFP)newObitTableGBTPARDATA2Row;
  theClass->ObitCopy        = NULL;
  theClass->ObitClone       = NULL;
  theClass->ObitClear       = (ObitClearFP)ObitTableGBTPARDATA2RowClear;
  theClass->ObitInit        = (ObitInitFP)ObitTableGBTPARDATA2RowInit;

} /* end ObitTableGBTPARDATA2RowClassDefFn */
 ...
 * \param inn Pointer to the object to initialize.
 */
void ObitTableGBTPARDATA2Init  (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableGBTPARDATA2 *in = inn;
 ...
 * For some reason this wasn't build into the GType class.
 * \param  inn Pointer to the object to deallocate.
 *           Actually it should be an ObitTableGBTPARDATA2* cast to an Obit*.
 */
void ObitTableGBTPARDATA2Clear (gpointer inn)
{
  ObitClassInfo *ParentClass;
  ObitTableGBTPARDATA2 *in = inn;
...
void ObitTableGBTPARDATA2ClassInit (void)
{
  ...
  /* Set function pointers */
  ObitTableGBTPARDATA2ClassInfoDefFn ((gpointer)&myClassInfo);
 
  myClassInfo.initialized = TRUE; /* Now initialized */
 
} /* end ObitTableGBTPARDATA2ClassInit */
...
static void ObitTableGBTPARDATA2ClassInfoDefFn (gpointer inClass)
{
  ObitTableGBTPARDATA2ClassInfo *theClass = (ObitTableGBTPARDATA2ClassInfo*)inClass;
  ...
  /* function pointers defined or overloaded this class */
  theClass->ObitClassInit = (ObitClassInitFP)ObitTableGBTPARDATA2ClassInit;
  theClass->ObitClassInfoDefFn = (ObitClassInfoDefFnFP)ObitTableGBTPARDATA2ClassInfoDefFn;
  theClass->ObitGetClass  = (ObitGetClassFP)ObitTableGBTPARDATA2GetClass;
  theClass->newObit       = (newObitFP)newObitTableGBTPARDATA2;
  theClass->ObitCopy      = (ObitCopyFP)ObitTableGBTPARDATA2Copy;
  theClass->ObitClone     = (ObitCloneFP)ObitTableClone;
  theClass->ObitClear     = (ObitClearFP)ObitTableGBTPARDATA2Clear;
  theClass->ObitInit      = (ObitInitFP)ObitTableGBTPARDATA2Init;
  theClass->ObitTableConvert = (ObitTableConvertFP)ObitTableGBTPARDATA2Convert;
  theClass->ObitTableOpen    = (ObitTableOpenFP)ObitTableGBTPARDATA2Open;
  theClass->ObitTableClose   = (ObitTableCloseFP)ObitTableGBTPARDATA2Close;
  ...
  theClass->ObitTableReadRow = 
    (ObitTableReadRowFP)ObitTableGBTPARDATA2ReadRow;
  theClass->ObitTableWriteRow = 
    (ObitTableWriteRowFP)ObitTableGBTPARDATA2WriteRow;

} /* end ObitTableGBTPARDATA2ClassDefFn */
 ...
 /* error checks */
  ...
  if (desc->FieldName) {
    for (i=0; i<desc->nfield; i++) {
      if (!strncmp (desc->FieldName[i], "DMJD", 4)) {
...
} /* end ObitTableGBTPARDATA2Update */
...
} /* end ObitTableGBTPARDATA2DumpKey */
