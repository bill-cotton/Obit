# Program to self calibrate galactic center P band data
...
# Init Obit
err=OErr.OErr()
ObitSys=OSystem.OSystem ("SCGCP", 1, 103, 1, ["None"], 1, ["../PythonData/"], 1, 0, err)
OErr.printErrMsg(err, "Error with Obit startup")

# Files
disk = 1
inFile   = "GCPbandCalOTF.fits"          # input OTF data
dirtFile = "!GCPDirty.fits"           # output dirty image file
beamFile = "DirtyBeam.fits"           # input dirty beam image
cleanFile= "!GCPClean.fits"           # output CLEAN image
...
OTF.ImageInput["xCells"] = 600.0 / 3600.0  # "X" cell spacing, deg
OTF.ImageInput["yCells"] = 600.0 / 3600.0  # "Y" cell spacing, deg
OTF.ImageInput["nx"] = 150                 # number of cells in X
OTF.ImageInput["ny"] = 150                 # number of cells in X
...
soln = [(120.0,30.0), (60.0,20.0), (30.0,10.5)]
# Loop over self cal
count=0
for si,mf in soln:
    count = count+1
