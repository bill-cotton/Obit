...
# debug - subtract a single point and don't restore
# OTF.CleanInput["niter"]    = 1    # Number of iterations
# OTF.CleanInput["gain"]     = 1.0   # CLEAN loop gain
# OTF.CleanInput["beamsize"] = -1.   # CLEAN restoring beam size in asec
