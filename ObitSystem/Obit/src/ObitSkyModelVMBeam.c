	...
	for (iChannel=lstartChannel; iChannel<startChannel+numberChannel; iChannel++) {
	  ...
	  case OBIT_SkyModel_PointMod:     /* Point */
		...
		if (doCrossPol) {
		  ...
		  sumRealQ += re * qgain1[iComp];
		  sumImagQ += im * qgain1[iComp];
		  sumRealU += re * ugain1[iComp];
		  sumImagU += im * ugain1[iComp];
		} /* end xpol */
