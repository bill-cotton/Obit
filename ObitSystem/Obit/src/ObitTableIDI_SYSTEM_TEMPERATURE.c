		     ...
		     ObitErr *err)
{
 ...
 /* error checks */
  ...
  strncpy (out->RefDate, "YYYY-MM-DD", MAXKEYCHARTABLEIDI_SYSTEM_TEMPERATURE );
...
ObitTableIDI_SYSTEM_TEMPERATURE* ObitTableIDI_SYSTEM_TEMPERATURECopy (ObitTableIDI_SYSTEM_TEMPERATURE *in, ObitTableIDI_SYSTEM_TEMPERATURE *out, ObitErr *err)
{
 ...
 /* error checks */
  ...
  strncpy (out->ArrName, in->ArrName, MAXKEYCHARTABLEIDI_SYSTEM_TEMPERATURE );
  strncpy (out->RefDate, in->RefDate, MAXKEYCHARTABLEIDI_SYSTEM_TEMPERATURE );
...
static void ObitTableIDI_SYSTEM_TEMPERATUREUpdate (ObitTableIDI_SYSTEM_TEMPERATURE *in, ObitErr *err)
{
 ...
 /* error checks */
  ...
  if (!ObitInfoListGet(in->myDesc->info, "ARRNAM", &type, dim, 
   ...
   /* RefDate */
  strncpy (in->RefDate, "YYYY-MM-DD", MAXKEYCHARTABLEIDI_SYSTEM_TEMPERATURE); 
