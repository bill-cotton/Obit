/* $Id: ObitFArray.c 7 2008-06-09 14:04:10Z bcotton $         */
/*--------------------------------------------------------------------*/
...
ofloat ObitFArrayRawRMS (ObitFArray* in)
{
  ...
  if (count<5) return -1.0; /* better have some */
...
{
  olong i, count;
  ofloat sum2, rawRMS, fblank = ObitMagicF();
