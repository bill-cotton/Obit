		     ...
		     ObitErr *err)
{
 ...
 /* error checks */
  ...
  ncol = 7 + out->numPol*3 + out->numIF*0 + out->numChan*0 ;
...
static void ObitTableJIUpdate (ObitTableJI *in, ObitErr *err)
{
 ...
 /* error checks */
  ...
  Obit_return_if_fail((in->NodeNoOff > -1), err,
       "ObitTableJIUpdate: Could not find column NodeNo");
  if (in->numPol>=1) {
    Obit_return_if_fail((in->Jones1Off > -1), err,
       "ObitTableJIUpdate: Could not find column Jones1");
    Obit_return_if_fail((in->Weight1Off > -1), err,
       "ObitTableJIUpdate: Could not find column Weight1");
  } /* end of if index in range */
  if (in->numPol>=2) {
    Obit_return_if_fail((in->Jones2Off > -1), err,
       "ObitTableJIUpdate: Could not find column Jones2");
    Obit_return_if_fail((in->Weight2Off > -1), err,
       "ObitTableJIUpdate: Could not find column Weight2");
  } /* end of if index in range */
