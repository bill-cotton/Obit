 ...
 * and can be used either for "self calibration" or correction a multisource 
 * Total Jones (JT) calibration table.
 * 
 * Calibration of the visibility on a baseline 1-2 can use the following:\hfill\break
 * J1 = inverse of Jones matrix for first antenna,\hfill\break
 * J2 = inverse of the conjugate transpose of the Jones matrix for second
 * antenna,\hfill\break
 * vis = 
 * \beginverbatim
 *
