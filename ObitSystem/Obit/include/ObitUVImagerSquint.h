/* $Id: ObitUVImagerSquint.h,v 1.3 2007/08/31 17:24:49 bcotton Exp $ */
/*--------------------------------------------------------------------*/
...
/*--------------------------------------------------------------------*/
#ifndef OBITUVIMAGERSQUINT_H 
#define OBITUVIMAGERSQUINT_H 
 ...
 * single plane.
 * 
 * \section ObitUVImagerSquintaccess Creators and Destructors
 * An ObitUVImagerSquint will usually be created using ObitUVImagerSquintCreate which allows 
 * specifying a name for the object as well as other information.
 *
 * A copy of a pointer to an ObitUVImagerSquint should always be made using the
 * #ObitUVImagerSquintRef function which updates the reference count in the object.
 * Then whenever freeing an ObitUVImagerSquint or changing a pointer, the function
 * #ObitUVImagerSquintUnref will decrement the reference count and destroy the object
 * when the reference count hits 0.
 * There is no explicit destructor.
 *
 * \section ObitUVImagerSquintparameters Control Parameters
...
/*--------------Class definitions-------------------------------------*/
/** ObitUVImagerSquint Class structure. */
typedef struct {
#include "ObitUVImagerSquintDef.h"   /* this class definition */
} ObitUVImagerSquint;

/*----------------- Macroes ---------------------------*/
/** 
 * Macro to unreference (and possibly destroy) an ObitUVImagerSquint
 * returns a ObitUVImagerSquint*.
 ...
 */
typedef struct  {
#include "ObitUVImagerSquintClassDef.h"
} ObitUVImagerSquintClassInfo; 

#endif /* OBITFUVIMAGERSQUINT_H */ 
