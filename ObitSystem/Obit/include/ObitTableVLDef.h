...
olong  CenterYCol;
/** Column offset for [OPTIONAL] Rotation measure at Center position in FIELD in table record */
olong  RMOff;
/** Physical column number for [OPTIONAL] Rotation measure at Center position in FIELD in table record */
olong  RMCol;
/** Column offset for [OPTIONAL] Error in RM in table record */
olong  RMerrOff;
/** Physical column number for [OPTIONAL] Error in RM in table record */
olong  RMerrCol;
/** Column offset for [OPTIONAL] E vector poln angle at ref. freq. in table record */
olong  EVPAOff;
/** Physical column number for [OPTIONAL] E vector poln angle at ref. freq. in table record */
olong  EVPACol;
/** Column offset for [OPTIONAL] Error in EVPA in table record */
olong  EVPAerrOff;
/** Physical column number for [OPTIONAL] Error in EVPA in table record */
olong  EVPAerrCol;
