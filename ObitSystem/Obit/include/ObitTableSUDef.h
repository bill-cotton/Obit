...
/*--------------------------------------------------------------------*/
/*  Define the basic components of the ObitTableSU  structure          */
/*  This is intended to be included in a class structure definition   */
/**
 * \file ObitTableSUDef.h
 * ObitTableSU structure members for derived classes.
 */
...
olong  DecAppCol;
/** Column offset for [OPTIONAL] Observed Right ascension in table record */
olong  RAObsOff;
/** Physical column number for [OPTIONAL] Observed Right ascension in table record */
olong  RAObsCol;
/** Column offset for [OPTIONAL] Observed Declination in table record */
olong  DecObsOff;
/** Physical column number for [OPTIONAL] Observed Declination in table record */
olong  DecObsCol;
