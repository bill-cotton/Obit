/* $Id: ObitSpectrumFitClassDef.h,v 1.1 2008/05/06 13:20:46 bcotton Exp $  */
/*--------------------------------------------------------------------*/
/*;  Copyright (C) 2008                                               */
...
/*--------------------------------------------------------------------*/
/*  Define the basic components of the ObitSpectrumFit ClassInfo structure */
#include "ObitClassDef.h"  /* Parent class ClassInfo definition file */
/** Function pointer to Constructor. */
ObitSpectrumFitCreateFP ObitSpectrumFitCreate;
...
ObitSpectrumFitSingleFP ObitSpectrumFitSingle;
