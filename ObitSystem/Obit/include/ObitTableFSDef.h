...
/*--------------------------------------------------------------------*/
/*  Define the basic components of the ObitTableFS  structure          */
/*  This is intended to be included in a class structure definition   */
/**
 * \file ObitTableFSDef.h
 * ObitTableFS structure members for derived classes.
 */
...
olong  Dec2000Col;
/** Column offset for Overall LSR velocity in table record */
olong  VelocityOff;
/** Physical column number for Overall LSR velocity in table record */
olong  VelocityCol;
/** Column offset for Velocity width in table record */
olong  VelWidthOff;
/** Physical column number for Velocity width in table record */
olong  VelWidthCol;
...
olong  CenterYCol;
/** Column offset for Center velocity position in pixels in FIELD in table record */
olong  CenterZOff;
/** Physical column number for Center velocity position in pixels in FIELD in table record */
olong  CenterZCol;
...
olong  JDProcessCol;
/** Column offset for Spectrum at Center X, Center Y in table record */
olong  SpectrumOff;
/** Physical column number for Spectrum at Center X, Center Y in table record */
olong  SpectrumCol;
/** Column offset for RMS in each channel in table record */
olong  RMSChOff;
/** Physical column number for RMS in each channel in table record */
olong  RMSChCol;
/** Column offset for Peak in each channel in table record */
olong  PEAKChOff;
/** Physical column number for Peak in each channel in table record */
olong  PEAKChCol;
