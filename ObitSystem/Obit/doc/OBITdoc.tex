...
{Polar position X (arcsec) on ref. date}
]
\tablekey[{"POLARY  "}{E}{PolarY}{0.0}{}
{Polar position Y (arcsec) on ref. date}
]
...
{Polarization parameterization type, 'APPR', 'RAPPR', 'ORI-ELP'}
]
...
\modhistory[{W. D. Cotton}{10/03/2016}{Polar X,Y units to arcsec}]
\end{history}
\clearpage
%%%%%%%%%%%%%%% ObitTableAT Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
...
% 
%
\ClassName[{ObitTableCD}]
ObitTableCD Class
\tabletitle{ ASDM CalDevice table for uv data}
% table name
\tablename{CD}
\tableintro[
{This class contains tabular data and allows access.
"AIPS CD" contains EVLA switched power measurements.TCal measurements
...
% Table keyword description
\begin{keywords}
\tablekey[{"NO\_IF"}{J}{nIF}{}{()}
{The number of IFs}
]
% Must be position 2 to index
\tablekey[{"NO\_POL "}{J}{nPol}{}{(1,2)}
{The number of polarizations.}
]
\tablekey[{"RDATE   "}{A}{RefDate}{"YYYY-MM-DD"}{}
{Reference date as "YYYYMMDD"}
...
\tablecol[{"TCAL\#NO\_POL"}{"KELVIN  " }{E}{(nIF)}{TCal}
{Cal. equivalent temp  Poln \# NPOL, invalid data fblanked}
]
\tablecol[{"SOLCAL\#NO\_POL"}{"KELVIN  " }{E}{(nIF)}{SolCal}
{Solar Cal. equivalent temp  Poln \# NPOL, invalid data fblanked}
] 
\end{columns}
%
% Table modification history
\begin{history}
\modhistory[{W. D. Cotton}{09/07/2010}{Revision 1: From EVLA memo}]
\modhistory[{W. D. Cotton}{04/03/2017}{Add SOLCAL1, SOLCAL2}]
\end{history}
%
\clearpage
%%%%%%%%%%%%%%% ObitTableCL Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\tablecol[{"TIME INT"}{"DAYS   " }{D}{(2)}{TimeI}
...
\tablecol[{"WOBXY "}{"ARCSEC" }{D}{(2)}{wobXY}
{Earth pole wobble}
] 
...
\begin{history}
\modhistory[{W. D. Cotton}{02/22/2006}{Revision 1: Copied from AIPS}]
\modhistory[{W. D. Cotton}{10/03/2016}{wobXY units to arcsec}]
\modhistory[{W. D. Cotton}{02/07/2018}{Add column TIME INT}]
\end{history}
%
...
{first and second antenna  numbers for a baseline, 0=$>$all}
] 
...
%%%%%%%%%%%%%%% ObitTableJI Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\ClassName[{ObitTableJI}]
{Incremental Jones matrix calibration table for UV data.}
%\ClassEnum[{obitObjType}
%{Type of underlying data structures}]

\tabletitle{Jones Incremental calibration table for UV data}
% table name
\tablename{JI}
\tableintro[
{This class contains tabular data and allows access.
...
vis = 
\begin{verbatim}
Circular feeds |RR RL| or for Linear |XX XY|
               |LR LL|               |YX YY|,
\end{verbatim}
then the calibrated visibility is \hfill\break
cal = ((J2$^{-1}$)*vis)*J1$^{-1}$
...
% Table keyword description
\begin{keywords}
\tablekey[{"REVISION"}{J}{revision}{12}{}
{Revision number of the table definition.}
]
\tablekey[{"NO\_IF  "}{J}{numIF}{}{()}
{The number of IFs}
...
\tablecol[{"JONES"}{"        "}{E}{(8,numChan,numIF)}{Jones}
{Array of 2x2 complex matices to be multiplied times 2x2 weighted visibilities,}
] 
\tablecol[{"WEIGHT"}{"        "}{E}{(numChan,numIF)}{Weight}
{Weight of soln., channel/IF, channel varing fastest.}
] 
\tablecol[{"REFANT"}{"        "}{J}{(numChan,numIF)}{RefAnt}
...
% Table modification history
\begin{history}
\modhistory[{W. D. Cotton}{04/22/2024}{Revision 1: Initial version}]
\modhistory[{W. D. Cotton}{05022/2024}{Revision 2: Add CALTYPE
  keyword, 12}]
\end{history}
%
%
...
%%%%%%%%%%%%%%% ObitTableJT Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\ClassName[{ObitTableJT}]
{Total Jones matrix calibration table for UV data.}
%\ClassEnum[{obitObjType}
%{Type of underlying data structures}]

\tabletitle{Jones Total calibration table for UV data}
% table name
\tablename{JT}
\tableintro[
{This class contains tabular data and allows access.
...
\tablecol[{"JONES"}{"        "}{E}{(8,numChan,numIF)}{Jones}
{Array of 2x2 complex matices to be multiplied times 2x2 visibilities,}
] 
\tablecol[{"WEIGHT"}{"        "}{E}{(numChan,numIF)}{Weight}
{Weight of soln., channel/IF, channel varing fastest.}
] 
...
% Table modification history
\begin{history}
\modhistory[{W. D. Cotton}{05/02/2024}{Revision 1: Initial version}]
\modhistory[{W. D. Cotton}{06/04/2024}{Revision 2: Drop second set of Jones}]
\end{history}
%
\clearpage
%%%%%%%%%%%%%%% ObitTableNI Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
%
\ClassName[{ObitTablePT}]
ObitTablePT Class
\tabletitle{Antenna PoinTing table for uv data}
% table name
\tablename{PT}
\tableintro[
{This class contains tabular data and allows access.
"AIPS PT" contains a series of antenna pointing records.
Generated from ALMA documentation which is error filled and vague.
An ObitTablePT is the front end to a persistent disk resident structure.
Both FITS and AIPS cataloged data are supported.
This class is derived from the ObitTable class. }
]
\tableover{
...
\tablecol[{"ENCODER"}{"DEGREES " }{E}{(2)}{Encoder}
{Encoder values in Az,El}
] 
\tablecol[{"POINTINGTRACKING"}{"       " }{L}{(1)}{pointingTracking}
{The antenna was in tracking mode?}
] 
\tablecol[{"USEPOLYNOMIALS"}{"       " }{L}{(1)}{usePolynomials}
{Use polynomials expansions?}
] 
\tablecol[{"TIMEORIGIN"}{"DAYS    " }{D}{(1)}{timeOrigin}
{The value used as origin in the polynomials expansions}
] 
\tablecol[{"POINTINGDIRECTION"}{"DEGREES "}{D}{(2,numTerm)}{PointingDirection}
{The commanded pointing direction in Az,El per term}
] 
\tablecol[{"TARGET"}{"DEGREES " }{D}{(2,numTerm)}{target}
{The direction of the field center in Az,El per term. }
] 
\tablecol[{"OFFSET"}{"DEGREES " }{D}{(2,numTerm)}{offset}
{The offset of the pointing direction at the time of the visibility 
dump (center time, optimally) from the field direction.}
] 
\tablecol[{"POINTINGMODELID"}{" " }{J}{(1)}{pointingModelId}
{Refers to a collection of rows in PointingModelTable.}
] 
\tablecol[{"OVERTHETOP"}{" " }{L}{(1)}{overTheTop}
{[OPTIONAL] Pointing at elevations larger than 90 degrees (true) or lower (false). }
] 
\tablecol[{"SOURCEOFFSET"}{" " }{D}{(2,numTerm)}{SourceOffset}
{[OPTIONAL] Sources offset in Az,El per term of the polynomia). }
] 
\tablecol[{"SOURCEREFERENCECODEOFF"}{" " }{J}{(1)}{SourceReferenceCodeOffset}
{[OPTIONAL] The direction reference code associated to the source offset.}
] 
\tablecol[{"SOURCEEQUINOXOFFSET"}{"DAYS   " }{D}{(1)}{sourceEquinoxOffset}
{[OPTIONAL] The equinox information (if needed by sourceReferenceCode). }
] 
\tablecol[{"SAMPLEDTIMEINTERVAL"}{"DAYS   " }{D}{(2)}{sampledTimeInterval}
{[OPTIONAL] An array of start, end of interval which must be given explicitly if
the data are irregularily sampled.}
] 
\tablecol[{"ATMOSPHERICCORRECTION"}{"DEGREES " }{E}{(2)}{AtmosphericCorrection}
{[OPTIONAL] This is the correction applied to the commanded position in Az,El to take 
into account refraction and any other atmospheric effects.  This term will always 
be zero if there is no atmosphere. For ALMA this is the atmospheric refraction 
correction and will result in a correction in just the elevation axis. }
] 
\end{columns}
%
% Table modification history
\begin{history}
\modhistory[{W. D. Cotton}{06/01/2016}{Revision 1: Invented from ASDM usage}]
\end{history}
...
\modhistory[{W. D. Cotton(from M. Kettenis)}{26/10/2015}{Revision 11: Add dispersive delay}]
\end{history}
%
\clearpage
%%%%%%%%%%%%%%% ObitTableSU Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 
%
\ClassName[{ObitTableSY}]
ObitTableSY Class
\tabletitle{ SysPower table for uv data}
% table name
\tablename{SY}
\tableintro[
{This class contains tabular data and allows access.
...
\tablecol[{"CAL TYPE "}{"        " }{J}{(1)}{CalType}
{[OPTIONAL] Calibration type 0=NOISE\_TUBE, 1=SOLAR\_FILTER, 2=Other}
]
\tablecol[{"SOURCE ID  "}{"        " }{J}{(1)}{SourID}
{Source ID number}
] 
...
\tablecol[{"POWER DIF\#NO\_POL"}{"    " }{E}{(nIF)}{PwrDif}
{ (P\_on-P\_off)*G  Poln \# NPOL ), invalid data fblanked}
] 
\tablecol[{"POWER SUM\#NO\_POL"}{"    " }{E}{(nIF)}{PwrSum}
{(P\_on+P\_off)*G  Poln \# NPOL ), invalid data fblanked}
] 
\tablecol[{"POST GAIN\#NO\_POL"}{"     "}{E}{(nIF)}{Gain}
{Post switched power gain Poln \# NPOL), invalid data fblanked}
] 
\end{columns}
%
% Table modification history
\begin{history}
\modhistory[{W. D. Cotton}{09/07/2010}{Revision 1: From EVLA memo}]
\modhistory[{W. D. Cotton}{06/01/2017}{Add optional column ``CAL TYPE''}]
\end{history}
%
\clearpage
%%%%%%%%%%%%%%% ObitTableTY Class %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
