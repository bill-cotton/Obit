...
\section{ObitMess Task Message Display}
...
If the window is expecting user input, the status becones ``Awaiting
user input'' and the task will suspend until the response is types
...
\ref{MessWinFig}.
\begin{figure}
\centerline{\psfig{figure=ObitMessScreen.eps,height=3in}}
\caption{ 
